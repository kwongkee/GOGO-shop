...
class Buy1Repository
{
    ...
    {
        if (empty($shop_cart_list) || !is_array($shop_cart_list)) {
            return [$shop_cart_list, [], 0];
        }
    ...
    {
        if (!is_array($shop_goods_total) || !is_array($shop_freight_total) || !is_array($shop_final_order_total)) {
            return [];
        }
    ...
    {
        if (!is_array($shop_bonus_total) || empty($shop_bonus_total)) {
            return $shop_promotion_total;
        }
