...
//            }
            ...
            //自定义方法 2024-01-09 START
            Route::get('checkvalue', 'Goods\PublishController@checkvalue'); // 检查是否有相同属性
            Route::get('getarea', 'Goods\PublishController@get_area'); // 获取国地区域
            Route::get('get_nextcate', 'Goods\PublishController@get_nextcate'); // 获取下级类别
            //自定义方法 2024-01-09 END
