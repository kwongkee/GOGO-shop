...
//        $tpl_backup_theme_where[] = ['site_id', 0];
        ...
        $shop_nav_list = $shop_navigation->toArray();
...
//                http://68test.oss-cn-beijing.aliyuncs.com/images/746/css/custom/m_shop-color-style-1.css?csv=67&v=20190422
                $url = __HTTP__.env('MOBILE_DOMAIN').'/css/custom/m_shop-color-style-'.seller_shop_info()->shop_id.'.css?csv=67&v='.date('Ymd');
            } else {
                $url = __HTTP__.env('MOBILE_DOMAIN').'/css/color-style.css';
            }
        }
