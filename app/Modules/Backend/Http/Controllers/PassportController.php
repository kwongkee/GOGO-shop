 ...
 */
class PassportController extends Backend2
{
...
//    protected $username;
    ...
    public function __construct(Request $request)
    {
        ...
        #版权信息
        $this->websites['copyright'] = $this->websites['info']['copyright'];
    }
    ...
    public function showLoginForm(Request $request)
    {
        ...
        $open = isset($data2['open']) ? intval($data2['open']) : 0;
        $param = isset($data2['param']) ? json_decode($data2['param'], true) : ['','','','','',''];#其它页面的携带参数
        $param2 = isset($data2['param2']) ? base64_decode($data2['param2']) : '';#其它页面的携带参数
...
//        $data['websites'] = $this->websites;
        ...
        return view('passport.login', compact('uuid', 'seo_title', 'website', 'page_info', 'country_code', 'authlogin_apps', 'open', 'param2', 'origin_page', 'data', 'autologin_apps2', 'login_content'));
    }
...
//        dd(bcrypt('888888'));
        ...
        if ($data['SmsLoginModel']['account']!='13119893380' && $data['SmsLoginModel']['account']!='13809703680' && $data['SmsLoginModel']['account']!='947960547@qq.com' && $data['SmsLoginModel']['account']!='13119893382' && $data['SmsLoginModel']['account']!='13202629133' && $data['SmsLoginModel']['account']!='18566883843' && $data['SmsLoginModel']['account']!='15816772124' && $data['SmsLoginModel']['account']!='hejunxin@gogo198.net') {
            #非公司内部成员，需验证
...
//            Log::info(json_encode($img, true));
            ...
            $img = 'https://backend.gogo198.cn/images/wxmini_img.png?v=' . $time;
