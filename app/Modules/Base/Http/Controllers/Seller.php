...
//            }
     ...
     */
    final protected function set_menu_select($active_module = '', $active_action = '')
    {
...
//        dd($menu_select);
    ...
    final protected function sublink($links = [], $actived = '', $group = '', $extra = '', $filter_link = '')
    {
        $fixedBarStr = '';
        $titleBarStr = '';
...
//                $actActived = strtolower($array[1]).'_'.$array[2];
     ...
     * @return mixed
     */
    final protected function getAppContext()
    {
        $user_info = [];
        if ($this->seller_id > 0) {
     ...
     */
    final protected function displayData()
    {
