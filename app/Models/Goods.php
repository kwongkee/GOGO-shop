...
//    ];
    ...
    protected $fillable = [
        ...
        'ext_info','remark',
        'shop_cat_ids',
        'promotion_text','activity_info','merchant_valueadd','platform_preferent','userprice_intro','platform_intro','crossborder_restrict','brand_type','brand_type2','crossborder_cate','have_specs','nospecs',
        'logistics_cate','crossb_cate1','crossb_cate2','crossb_cate3','delivery_location','delivery_area1','delivery_area2','service_type','domestic_type','domestic_baoyou','cross_logi','cross_logi_baoyou','cross_logi_clean','cross_logi_freightfee','cross_logi_taxfee','cross_logi_peisong','cross_logi_daomen','cross_logi_daocang','reduction_content','gift_content','noinclude_content','potential_content','otherfee_content','zhuanyun'
