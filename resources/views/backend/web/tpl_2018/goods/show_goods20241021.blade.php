...
@section('content')
    ...
    <div class="w1210">
        ...
        <style>
            ...
            .store-info_container{width:200px;margin-left:10px;background:#fff;margin-top: 0px;}
            .store-info_container .buy-shopBox {padding: 20px 18px 18px;position: relative;}
            .store-info_container .buy-shopBox .shopBox-header {box-shadow: 0px 0px 5px 1px #bebebe;align-items: center;color: #373737;display: flex;font-size: 14px;justify-content: space-between;line-height: 16px;margin-bottom: 14px;overflow: hidden;position: relative;text-overflow: ellipsis;white-space: nowrap;}
            .store-info_container .buy-shopBox .shopBox-header p {font-size: 18px;font-weight: 700;line-height: 18px;}
            .store-info_container .buy-shopBox .shopBox-header button {background: {{$website['color']}};width:100%;border: none;color: #fff;cursor: pointer;font-size: 14px;padding: 7px 10px;transition: all .3s linear;}
            .store-info_container .buy-shopBox .shop-title {border-bottom: 1px solid #000;margin-bottom: 14px;overflow: hidden;padding-bottom: 14px;text-overflow: ellipsis;white-space: nowrap;font-size:14px;color:#000;}
            .store-info_container .buy-shopBox .shopBox-body {background: #fff;box-sizing: border-box;color: #999;text-align: center;}
            .store-info_container .buy-shopBox .shopBox-body>span {color: #000;text-align:center;font-size: 15px;}
            ...
            .store-info_container .buy-shopBox .shopBox-body .shop-score {border-bottom: 1px solid #000;margin-top: 20px;padding-bottom: 15px;}
            .store-info_container .buy-shopBox .shopBox-body .shop-score li {display: flex;margin-bottom: 14px;}
            .store-info_container .buy-shopBox .shopBox-body .shop-score li span {color: #000;font-size: 14px;line-height: 12px;margin-right: 10px;}
            ...
            .choose dl.attr dd li.selected a{border:2px solid #e60000;}
            .choose dl.attr dd li a span{max-width: 200px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;}
            /**已选规格**/
        ...
        <div class="disf" style="align-items: normal;margin-top:20px;">
            <div class="goods-info">
                ...
                <div class="detail-info">
                    ...
                    <!--代购须知-->
                        <style>
                            .detail-info h1.goods-name{color: #e60000 !important;}
                            .second-color{color:#e60000;}
                            .goodsgallery .gg-current-img{box-shadow: 0px 0px 5px 0px #bebebe;}
                            ...
                            .goods-url{font-size:14px;font-weight:600;color:#1f5188;}
                            .goods-url:hover{text-decoration: underline;color:#1f5188;}
                        ...
                        @if($goods['shop_id']==0)
                            <div class="helpBox disf">
                                <a href="{{$website['agentLink']}}" target="_blank">
                    ...
                    <!-- 商品名称 -->
                        ...
                        <!-- 商品简单描述 -->
                            <p class="goods-brief second-color">
                                <a href="{{$goods['other_goods_link']}}" target="_blank" class="goods-url">原文链接&gt;</a>
                            </p>
                        @endif
                        ...
                        <div class="goods-price">
                            ...
                            <div class="realy-price">
                                <div class="now-prices">
                                    @if($goods['shop_id']==0)
                                        <strong class="p-price second-color SZY-GOODS-PRICE">CNY <span class="SZY-PRICE">{{ $goods['goods_price'] }}</span></strong>
                                        <div class="exchangeBtn" onclick="exchangeBtn({{$goods['goods_price']}})">货币转换</div>
                                    @else
                                        @if($goods['have_specs']==1)
                                            <div class="low_price disf">
                                                <strong class="p-price second-color SZY-GOODS-PRICE">{{$goods['currency']}} {{ $goods['goods_price'] }}</strong><img src="/images/gantanhao.png" class="price_info gantan">
                                                <div class="exchangeBtn" onclick="exchangeBtn({{$goods['goods_price']}})">货币转换</div>
                                            </div>
                                            <div class="interval_div showDIV" style="display: none;z-index: 9;background: #fff;">
                                        ...
                                        @elseif($goods['have_specs']==2)
                                            ...
                                            <div class="interval_div showDIV" style="display: none;background:#fff;z-index: 9;">
                            ...
                            <div class="reson-tips" style="font-size:14px;color:#000;">
                                <p>{{$time_interval}}</p>
                            </div>
                            <style>
                                ...
                                .new-goods-options-content .label-title {color: #666;font-size: 12px;font-weight:600;}
                                ...
                                <dl class="goods-options-row goods-options-freight">
                                    <dd class="cn new-goods-options-content">
                                        <div class="label label-one">
                                            <span class="label-title">国内供应商</span>
                                            <span class="font-icon arrow">&gt;</span>
                                            <span class="label-title">Gogo国内集货仓</span>
                                            <span class="font-icon arrow">&gt;</span>
                                            <span class="label-title">中国境外收货地址：</span>
                                        ...
                                        <div class="label label-tow country-select" style="display:@if(!empty($address))
                                                block
                                        @else
                                                none
                                        @endif;">
                                                        ...
                                                        <select name="address_id" id="address_id" style="border: 1px solid #000;padding: 0px 10px;width: 220px;color:#000;" lay-verify="required">
                                                            ...
                                                            @if(!empty($address))
                                                                @foreach($address as $k=>$v)
                                                                    ...
                                                                    selected
                                                                            @endif>{{$v['user_name']}}，{{$v['mobile']}}，{{$v['true_addr']}}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                    </div>
                        ...
                        @if($goods['have_specs']==1)
                            <!--已选规格-->
                                <dl class="already_select amount amount_num">
                                    <dt class="dt">已选规格</dt>
                                    <dd class="dd">
                                        @if(!empty($goods['spec_list']))
                                            <div class="optionSel">
                        ...
                        <!-- 购买数量 -->
                            ...
                            <div class="support-pay-list" style="display:none;">
                                <dl>
                            ...
                            <!--购物清单-->
                            <style>
                                .buy_list{position:relative;width: 100%;}
                            ...
                            <div class="disf">
                                <div class="layui-btn layui-btn-md layui-btn-success" style="background:#ff0000;margin-top:0px;" onclick="join_list()">加入清单</div>
                                            ...
                                            <div class="buy_info">
                                                ...
                                                <!--服务-->
                                                    <style>
                                                        ...
                                                        .alselBox .servicesDiv{background:#fff;padding:20px;box-sizing: border-box;box-shadow: 0px 0px 10px 1px #999;position: absolute;top: 20px;left: 0px;background: #fff;z-index: 11;min-width: 600px;}
                                                    </style>
                                                    <div class="gi_services disf gi_border">
                                                        <div class="gi_label">更多服务</div>
                                                        <div class="gi_info disf">
                                                            <div class="alselBox">
                                                                <div class="alsel">已选<span class="projectNum">1</span>项</div>
                                                                <div class="servicesDiv" style="display: none;">
                                                                    <input type="number" id="service_money" value="{{$services_money}}" style="display: none;">
...
@endif" onclick="select_services({{$v['id']}},{{$v['type']}},this,'{{$v['name']}}')" @if($v['is_select']==1)
                                            ...
                                            <div class="sort_div">
                                                ...
                                                <div class="layui-form-item">
                                                    ...
                                                    <div class="layui-input-block postal_div hide2">
                                                        <div class="disf">
                                                            <div style="width:38px;">例子：</div>
                                                            <div class="postal_rule disf"></div>
                                                        </div>
                                                        <div class="disf">
                                                            <div style="width:38px;">填写：</div>
                ...
                <script type="text/javascript">
                    ...
                    function setSkuInfo(sku) {
                        ...
                        //设置价格为最低
                        $('.low_price').find('.SZY-GOODS-PRICE').text(sku.low_price);
                        //商品规格区间 2024/01/19添加
                        ...
                        @else
                        $('.SZY-GOODS-PRICE').text(sku.low_price);
                        @endif
            ...
            <div class="store-info_container buy-aside">
                @if($goods['shop_id']==0)
                    <div class="buy-shopBox">
                        <div class="shopBox-header">
                            {{--                            <p>SHOP</p>--}}
                            <button data-key="shop-modal" class="go-shop" onclick="javascript:window.open('https://shop{{$goods['other_shop']['shopId']}}.taobao.com/#/');">供货商</button>
                        </div>
                        <p class="shop-title" title="{{$goods['other_shop']['shopName']}}">{{$goods['other_shop']['shopName']}}</p>
                        <div class="shopBox-body">
                            <span><!--<em class="">4.9</em>-->综合商誉</span>
                            <ul class="shop-score">
                                <li>
                ...
                @else
                    <div class="buy-shopBox">
                        <div class="shopBox-header">
                            {{--                            <p>SHOP</p>--}}
                            <button data-key="shop-modal" class="go-shop" onclick="javascript:window.open('shop/{{$goods['shop_id']}}.html');">供货商</button>
                        </div>
                        <p class="shop-title" title="{{$goods['shop_name']}}">{{$goods['shop_name']}}</p>
                        <div class="shopBox-body">
                            <span><!--<em class="">4.9</em>-->综合商誉</span>
                            <ul class="shop-score">
                                <li>
        ...
        <div class="clearfix">
                ...
                <div class="store-service storeName" style="border-top:1px solid #f2f2f2;margin-bottom:0;">
                    <div class="store-service-group left-content" style="margin-bottom:0;">
                        <div class="store-service-type first" style="padding-bottom:0;">
                            ...
                            @else
                                <h3 class="left-title" title="{{ $goods['other_shop']['shopName'] }}">{{ $goods['other_shop']['shopName'] }}</h3>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <style>
                ...
                .goodsDetail_fixed{position:fixed;top:0;left:50%;transform: translate(-50%,0);z-index: 9;}
                ...
                .low_price{width:210px;justify-content: space-between;}
                .gantan{width:25px;cursor:pointer;}
                .exchangeBtn{background:{{$website['color']}};color:#fff;padding:2px 10px;box-sizing: border-box;font-size:14px;margin-left:5px;cursor:pointer;box-shadow: 0px 0px 5px 1px #bebebe;}
                div[type="iframe"]{top:50% !important;transform: translate(0%,-50%);}
                div[type="dialog"]{top:50% !important;transform: translate(0%,-50%);}
                ...
                /**浮窗**/
                .fuchuang{right: 0% !important;transform: translate(-350%, 0);}
                /*@media screen and (max-width: 1200px){*/
                /*    .fuchuang{right: 0% !important;transform: translate(-300%, 0);}*/
                /*}*/
            </style>
...
@endif switch_process" onclick="switch_process({{$k}},this)">{{$v['step']}}：{{$vo['content']}}</div>
                    ...
                    @else
                        ...
                        <div class="layui-tab-content" style="min-height: 400px;">
                            <div class="layui-tab-item layui-show">
                                <div class="detail_bottom goods-detail-content" style="text-align:center;/**height:633px;overflow-y:scroll;**/">
                                </div>
                            </div>
                        </div>
                    @endif
                ...
                form.on('submit(glist-element2)', function(data){
                    ...
                    if($('#address_id').val()==''){
                        ...
                        return false;
                            ...
                            @if($goods['shop_id']==0)
                    var data = {'buy_attr':buy_attr,'id':"{{$goods['goods_id']}}",'address_id':$('#address_id').val(),'services_attr':services_attr};
                    $.ajax({
...
<!-- 在售的商品 _start(废弃) -->
<div class="choose SZY-GOODS-SPEC-ITEMS" style="display: none;">
    <!-- 商品规格 -->

@if(!empty($goods['spec_list1']))
    @foreach($goods['spec_list'] as $k=>$v)
        @if(isset($v['attr_name']))
            <!-- 如果规格下没有库存，红色提示背景给dl标签追加class值"no-stock-bg" -->
                <dl class="attr">
