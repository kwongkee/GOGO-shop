@include('layouts.header')
    ...
    <style>
        ...
        .goods_list .shop-item .shop-name {color: {{$website['color']}};font-weight:800;}
        .goods_list .shop-item .warehouse {background: {{$website['color']}};border-radius: 2px;color: #fff;float: left;margin-right: 10px;padding: 5px 9px;font-size:14px;font-weight:800;}
        ...
        .confirm-order .submit-button button {background-color: {{$website['color']}};box-sizing: border-box;font-size: 16px;height: 40px;margin-left: auto;margin-right: 20px;width: 180px;border:0;color:#fff;font-weight: 800;}
