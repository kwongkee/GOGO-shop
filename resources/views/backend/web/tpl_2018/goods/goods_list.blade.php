...
{{--        @include('goods.partials.hot_sale_goods')--}}

        <!--当前位置，面包屑-->
        @include('frontend.web.modules.library.url_here')

        <!--分类页下，当前分类是否还有下级分类-->
        @if($params['have_cate']==1)
            <div class="category-layer category-layer2 child_child" style="background:#3A3A3A;top:0;">
                <span class="category-layer-bg bg-color"></span>
                <style>
                    .child_child{height:200px !important;}
                    .child_child .list .categorys{height:200px !important;min-height:200px !important;overflow-y:auto;overflow-x:hidden;}
                    .child_child .list .categorys .subitems{width: 100%;}
                    .fore1 dd{width: 80% !important;max-width: 80% !important;}
                </style>
                <div class="list">
                    <dl class="cat">
                        <dt class="cat-name">
                            <i class="iconfont"></i>
                            <a href="" target="_blank" title="{{$params['now_cate']->cat_name}}">{{$params['now_cate']->cat_name}}</a>
                        </dt>
                        <i class="right-arrow">&gt;</i>
                    </dl>
                    <div class="categorys" style="display: block !important;">
                        <div class="item-left fl" style="width: 100%;">
                            <div class="subitems">
                                @foreach($params['next_cate'] as $k=>$v)
                                    <dl class="fore1">
                                        <dt style="width: 75px;">
                                        ...
                                        <dd style="width: 100%;">
                                            @if(!empty($v->child))
                                                @foreach($v->child as $child)
                                                    <a href="{{ route('pc_goods_list', ['cat_id' => $child->cat_id]) }}" target="_blank" title="{{$child->cat_id}}">{{$child->cat_name}}</a>
                                                @endforeach
                                            @endif
                                        </dd>
                                    </dl>
            ...
            <script>
                $(function(){
                    $('.child_child').find('.list').hover(function(){
                        $('.child_child').find('.categorys').show();
                    });
                })
            </script>
        @endif
        ...
        <div class="content-wrap category-wrap clearfix">
            ...
            <div class="aside" >
                ...
                <div class="aside-inner">
                    ...
                    @include('goods.partials.new_goods')
        ...
        <div class="browse-history">
            ...
            <div class="browse-history-con">
                <div class="browse-history-inner">
                    ...
                    <!--浏览历史-->
                    @include('goods.partials.history_goods')
