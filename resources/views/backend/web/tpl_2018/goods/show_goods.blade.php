...
<script src="/assets/d2eace91/js/layer/layer.js?v=20250528"></script>
...
@show
    ...
    <script type="text/javascript" src="/assets/d2eace91/layui/layui.js?v=2311"></script>
    ...
    <style>
        ...
        .bdshare_dialog_list li{width:125px;}
        /*弹窗位置*/
        ...
        @media (max-width: 992px){
            ...
            .w1210{width: 100% !important;margin: 0px 0 0;}
            ...
            .detailContent{margin-bottom:0;}
            .detailContent .detailBtm .detailBtmLeft{margin-bottom:0;}
            /*商品基本信息===start*/
            ...
            /*参数信息*/
            .detailContent .detailBtm .detailBtmLeft .detailBtmInfo .infoItem--Z4hNxv8b .infoItemTitle--P41WPBIx{overflow: hidden;text-overflow: ellipsis;display: -webkit-box;-webkit-line-clamp: 3;-webkit-box-orient: vertical;width: 100%;height: 56px;}
            /*商品基本信息===end*/

            /*页脚*/
            footer .widgetheading{margin-top:15px;}
        }
    </style>
    <div class="w1210">
        <div class="disf" style="align-items: normal;margin-top:20px;">
            <div class="goods-info common_inner_background">
                <!-- 商品详细信息 -->
                <!-- 商品图片以及相册 _star-->
...
{{--                                        <div class="btn_buy yixuan show_list" onclick="show_glist(this)"><img src="/images/book.png" style="width:20px;height:20px;"></div>--}}
                                        <div class="btn_buy yixuan show_list" onclick="javascript:window.location.href='//www.gogo198.cn/cart.html?mid={{$userId}}';"><img src="/images/book.png" style="width:20px;height:20px;"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            if("{{session('user.user_id')}}" != ''){
                                ...
                                $.ajax({
                                    ...
                                    success: function (res) {
                                        ...
                                        if (res.code == 0) {
                                            window.location.href='//www.gogo198.cn/order_confirm?cart_id='+res.cart_id+'&mid={{$userId}}';
                                        }else if(res.code==-1){
                                            layer.msg(res.msg);
                                        }
                                        // });
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('scroll', function() {
            ...
            if (scrollPosition >= 700) {
                $('.detailContent .detailHead').css({'position':'fixed','top':'83px'});
            }else{
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if (res.code == 0) {
                            ...
                            layer_frame_div = open_frame('信息',res.msg,'//www.gogo198.cn/cart.html?mid={{$userId}}','查看选购','javascript:window.location.reload();','继续选购',1,area,1);
