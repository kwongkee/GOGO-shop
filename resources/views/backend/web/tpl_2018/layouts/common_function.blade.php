...
<script>
    ...
    function connect_kefu(){
        ...
        @if(!empty(session('user')))
            let area = ['600px','450px'];
            let html = '<div class="body" style="padding:10px;box-sizing: border-box;height:100%;"><iframe src="https://boss.gogo198.cn/?s=customer/customer_online&pa=2&who_send=2&id=0&pid=0&isframe=1&company_id=<?php echo $data['websites']['cid'];?>&uid=<?php echo session('user.gogo_id');?>" frameborder="0" style="width:100%;height:100%;"></iframe></div>';
