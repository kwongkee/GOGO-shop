...
<style>
    ...
    *,:after,:before {-webkit-box-sizing: border-box;box-sizing: border-box}
    ...
    .next-btn.next-btn-normal:hover {background-color: #fff;border-color: {{$website['color']}};color: {{$website['color']}};cursor:pointer;}
    ...
    .cart-tab--tabsWrapper--X_97uZl .next-tabs-tab.active .next-tabs-tab-inner {font-size: 16px;font-weight:800;color: {{$website['color']}};}
    ...
    .shop-top--companyWrapper--Nng6NUE .shop-top--companyName--xT5dktx {color: {{$website['color']}};font-size: 16px;margin-left: 12px;font-weight:800;}
    ...
    .cart--header--ow5WRyV {background: #f7f7f7;border-radius: 0;padding: 0 20px;border:1px solid {{$website['color']}};border-top:0;}
    .cart--header--ow5WRyV .select_div{margin: 0 -20px;padding: 0 20px;border-top:1px solid {{$website['color']}};}
    ...
    /*清单*/
    .albuy_div .order_listDiv{margin-bottom:0px;border-bottom:1px dashed {{$website['color']}};}
    ...
    .view_btn{background:{{$website['color']}};color:#fff;}
    .view_btn:hover{color:#fff !important;}
    .view_btn:active{color:#fff !important;}
                                        ...
                                        <div class="shop-container--container--_pNFLjq">
                                            <div class="shop-top--container--GWvjt50">
                                                <div class="shop-top--companyWrapper--Nng6NUE">
                                                    ...
                                                    @if(isset($cart_list[0]['shop_info']['shop_name']))
                                                        <a class="shop-top--companyName--xT5dktx" href="#" target="_blank">{{ $cart_list[0]['shop_info']['shop_name'] }}</a>
                                                    @else
                                            ...
                                            <div class="bottom-bar--rightPanel--jGm5nNN">
                                                ...
                                                <div class="bottom-bar--operationPanel--jELCo_1">
                                                    <div class="next-btn next-large next-btn-primary bottom-bar--submitBtn--i_YrJri">
                                                        <span class="next-btn-helper" style="padding: 5px 20px;border: 1px solid {{$website['color']}};background: {{$website['color']}};color: #fff;line-height: 32px;font-weight:800;" onclick="buy_goods()">立即购买</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    var layer_frame_div = '';
    function del(t,typ,cart_id,sku_id){
        var $ = layui.$
            , form = layui.form
            , layer = layui.layer;
        ...
        if(typ==0){
            html = '<div class="body" style="padding:10px;box-sizing: border-box;"><div class="msg" style="font-size: 15px;color: #000;width: 100%;overflow-y: auto;margin-bottom:20px;">确认要删除该规格吗？</div><div class="btnGroup" style="display: flex;align-items: center;justify-content: center;"><a style="padding:5px 10px;background:{{$website['color']}};font-size:15px;font-weight:800;color:#fff;margin-right:20px;" href="javascript:sure_del(2,'+cart_id+','+sku_id+','+typ+');">确认</a><a href="javascript:sure_del(0);" style="padding:5px 10px;background:#db1d18;font-size:15px;font-weight:800;color:#fff;">取消</a></div></div>';
            ...
            html = '<div class="body" style="padding:10px;box-sizing: border-box;"><div class="msg" style="font-size: 15px;color: #000;width: 100%;overflow-y: auto;margin-bottom:20px;">确定要删除该商品吗？</div><div class="btnGroup" style="display: flex;align-items: center;justify-content: center;"><a style="padding:5px 10px;background:{{$website['color']}};font-size:15px;font-weight:800;color:#fff;margin-right:20px;" href="javascript:sure_del(1,'+cart_id+','+sku_id+','+typ+');">确认</a><a href="javascript:sure_del(0);" style="padding:5px 10px;background:#db1d18;font-size:15px;font-weight:800;color:#fff;">取消</a></div></div>';
            ...
            if(sku_length>0){
                html = '<div class="body" style="padding:10px;box-sizing: border-box;"><div class="msg" style="font-size: 15px;color: #000;width: 100%;overflow-y: auto;margin-bottom:20px;">确认将'+sku_length+'个商品删除？</div><div class="btnGroup" style="display: flex;align-items: center;justify-content: center;"><a style="padding:5px 10px;background:{{$website['color']}};font-size:15px;font-weight:800;color:#fff;margin-right:20px;" href="javascript:sure_del(3,\''+cart_ids+'\',\''+sku_ids+'\','+typ+');">确认</a><a href="javascript:sure_del(0);" style="padding:5px 10px;background:#db1d18;font-size:15px;font-weight:800;color:#fff;">取消</a></div></div>';
