...
<style>
    ...
    *,:after,:before {-webkit-box-sizing: border-box;box-sizing: border-box}
    ...
    .albuy_div .cart_detail_title{background:{{$website['color']}};color: #ffffff;font-size: 20px;font-weight: 800;padding: 5px 30px;box-sizing: border-box;}
    ...
    .layer_frame .page_innerhead .pageAct{background:{{$website['color']}};color:#fff;}
...
{{--                                        </div>--}}
                                        <!--清单操作-->
                                        <div class="operaDiv" style="background: #fff;padding: 10px 20px;border-top: 1px solid {{$website['color']}};">
