...
<script type="text/javascript">
    $(function() {
        ...
        @if(!empty($admin) && empty(session('admin')))
            $('#adminloginmodel-username').val("{{$admin->user_name}}");
            $('#adminloginmodel-password').val('111111');
            // $('#back_url').val("/goods/default/list");
            $('#back_url').val("https://backend.gogo198.cn/");
            // setTimeout(function(){
            //     $('#btn_submit').click();
            // },1000);
        @endif
...
<script type="text/javascript">
    $().ready(function() {
        ...
        $("#btn_submit").click(function() {
            ...
            // let back_url = $('#back_url').val();
            // if(back_url != ''){
            //     window.location.href='https://backend.gogo198.cn'+back_url;
            // }
        });
