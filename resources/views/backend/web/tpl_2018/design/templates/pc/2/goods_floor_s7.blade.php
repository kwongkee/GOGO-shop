...
{{--                                     route('goods_list', ['cat_id'=>$v['cat_id']]) 改20240304--}}
                                    <a href="" target="_blank" class="tags-item" style="border-color:{{ @$data['4-3'][0]['bgcolor'] != null ? $data['4-3'][0]['bgcolor'] : '' }};">{{ $v['cat_name'] }}</a>
                                @endforeach
                            @else
                                @for($i=1; $i <= 3; $i++)
