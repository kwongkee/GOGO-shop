...
@section('content')
    ...
    <!-- 公共css -->
    <link rel="stylesheet" href="https://{{ env('API_DOMAIN') }}/frontend/web/css/common.css?v=1.6"/>

    <link rel="stylesheet" href="https://{{ env('API_DOMAIN') }}/frontend/web/css/index.css?v=1.6"/>
    <link rel="stylesheet" href="https://{{ env('API_DOMAIN') }}/frontend/web/css/template.css?v=20180702"/>


    <!-- 风格样式 -->
    <!--整站改色 _start-->
    @if(sysconf('custom_style_enable') == 1)
        <link rel="stylesheet" href="https://{{ env('API_DOMAIN') }}/frontend/web/css/custom/site-color-style-0.css?v=1.6" id="site_style"/>
    @else
        <link rel="stylesheet" href="https://{{ env('API_DOMAIN') }}/frontend/web/css/color-style.css?v=1.6" id="site_style"/>
    @endif
    <!--整站改色 _end-->
    ...
    <div class="module-main unfold template-one"  style="padding-bottom:100px;">
        ...
        <div class="SZY-TPL-HEADER m-t-5">
            ...
            <div class="category-box">
                ...
                <style>
                    .category-layer2 .list .cat{width:100%;}
                    .category-layer2 .list{height: 40px;}
                    .category-layer2 .list .cat {height: 100%;}
                </style>
