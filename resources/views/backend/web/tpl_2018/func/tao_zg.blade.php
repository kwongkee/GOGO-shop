...
@section('content')
    ...
    <div class="w1210">
        <form class="layui-form" action="" method="post" lay-filter="search-element">
            <div style="width: 100%;text-align: center;">
                <img src="https://shop.gogo198.cn/attachment/images/3/2017/04/gIjml75Zrz5rKqNm55j7Ym03d0LIRZ.png" alt="" class="logo_search">
            </div>
            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block disf">
                            <img src="https://shop.gogo198.cn/attachment/images/3/2017/04/gIjml75Zrz5rKqNm55j7Ym03d0LIRZ.png" alt="" class="tao_img">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
                            ...
                            if (res.code == 0) {
                                ...
                                for(let i=0;i<res.data.length;i++){
                                    html += '<div class="goods_box">\n'+
                                            ...
                                            '        <img src="'+res.data[i].picUrl+'" class="img">\n'+
                                            '    </div>\n'+
        ...
        function view_detail(id){
            window.location.href="/taozg_detail?id="+id;
        }
    </script>
@stop