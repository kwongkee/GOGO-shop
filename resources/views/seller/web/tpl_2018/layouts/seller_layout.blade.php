            ...
            <div class="user-info">
                ...
                <div class="user-dropdown">
                    ...
                    <div class="user-dropdown-select">
                        ...
                        <a  href='{{ route('pc_shop_home',['shop_id'=>@$shop_info->shop_id]) }}' target="_blank">前往店铺</a> <a href="http://{{ env('FRONTEND_DOMAIN') }}/user/security/edit-password.html" >修改密码</a> <a  onClick="clearCache()">清除缓存</a> <a href="/site/logout" data-method="post" data-confirm="您确定要退出卖家中心吗？">安全退出</a> </div>
                </div>
            </div>
