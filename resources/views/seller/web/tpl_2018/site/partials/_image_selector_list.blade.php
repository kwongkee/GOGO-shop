...
{{--                x-oss-process=image/resize,m_pad,limit_0,h_120,w_120--}}
                <img class="image-box" src="{{ get_image_url($v->path) }}?v=12345" data-path="{{ $v->path }}" data-url="{{ get_image_url($v->path) }}" data-width="{{ $v->width }}" data-height="{{ $v->height }}" />
