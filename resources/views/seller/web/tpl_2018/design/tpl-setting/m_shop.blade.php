...
@section('content')
    ...
    <link rel="stylesheet" href="http://{{ env('MOBILE_DOMAIN') }}/css/dianpu.css?v=20190422"/>
    <link rel="stylesheet" href="http://{{ env('MOBILE_DOMAIN') }}/css/shop_header.css?v=20190422"/>
    <!--整站改色 _start-->
    <!--整站改色 _start-->
    @if(shopconf('custom_style_enable_m_shop') == 1)
        {{--<link rel="stylesheet" href="http://68test.oss-cn-beijing.aliyuncs.com/images/746/css/custom/m_shop-color-style-1.css?csv=67&v=20190422"/>--}}
        <link rel="stylesheet" href="http://{{ env('MOBILE_DOMAIN') }}/css/custom/m_shop-color-style-{{ $shop_info['shop']['shop_id'] }}.css?csv=67&v={{ date('Ymd') }}"/>
    @else
            ...
            <div class="topBar-navbar-r">
                ...
                <div class="other-more">
                    ...
                    <div class="more-set" style="display: none;">
                        ...
                        <ul>
                            <li>
                                <a class="other-help" target="_blank" href="http://help.mall.laravelvip.com/">
                                    <i></i>
                                    帮助中心
                                </a>
                            </li>
