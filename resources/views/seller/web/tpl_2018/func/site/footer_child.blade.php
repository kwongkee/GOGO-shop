            ...
            <div class="layui-card">
                <div class="layui-card-body" style="background:#fff;padding:10px;">
                    <div class="layui-btn-group test-table-operate-btn" style="margin-bottom: 10px;">
                        <button class="layui-btn layui-btn-normal" onclick="openWindow('添加菜单','/func/site/save_footer?pid={{$pid}}');">添加菜单</button>
...
<script>
    layui.config({
        ...
        table.render({
            elem: '#mainTable'
            ,url: "/func/site/footer_child?pa=1&pid={{$pid}}"
            ,cellMinWidth: 200
            ,cols: [[
                ...
                ,{width:120, align:'center', fixed: 'right', title: '操作', templet: function(d){
                        ...
                        return [
                            '<a onclick="openWindow('+ "'["+d.name+"]编辑'" +',' + "'/func/site/save_footer?pid={{$pid}}&id="+ d.id + '\');" class="layui-btn layui-btn-xs layui-btn-normal">编辑</a>',
