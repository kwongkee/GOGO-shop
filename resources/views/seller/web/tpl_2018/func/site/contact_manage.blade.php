            ...
            <div class="layui-card">
                <div class="layui-card-body" style="background:#fff;padding:10px;">
                    <div class="layui-btn-group test-table-operate-btn" style="margin-bottom: 10px;">
                        <button class="layui-btn layui-btn-normal" onclick="openWindow('添加社交','/func/site/save_contact');">添加社交</button>
...
<script>
    layui.config({
        ...
        table.render({
            elem: '#mainTable'
            ,url: "/func/site/contact_manage?pa=1"
            ,cellMinWidth: 200
            ,cols: [[
                {field:'id', width:80, title: 'ID'}
                ,{field:'name',  title: '社交名称'}
                ,{width:120, align:'center', fixed: 'right', title: '操作', templet: function(d){
                        var result = "";

                        return [
                            '<a onclick="openWindow('+ "'["+d.name+"]编辑'" +',' + "'/func/site/save_contact?id="+ d.id + '\');" class="layui-btn layui-btn-xs layui-btn-normal">编辑</a>',
    ...
    function del(id){
        ...
        layer.confirm('确认要删除该联系方式吗？',{
            btn:['删除','取消']
        }, function(){
            $.ajax({
                url:"/func/site/del_contact",
                method:'post',
