            ...
            <div class="layui-card">
                <div class="layui-card-body" style="background:#fff;padding:10px;">
                    <div class="layui-btn-group test-table-operate-btn" style="margin-bottom: 10px;">
                        <button class="layui-btn layui-btn-normal" onclick="openWindow('添加内容','/func/site/save_guide_content?pid={{$pid}}');">添加内容</button>
...
<script>
    layui.config({
        ...
        table.render({
            elem: '#mainTable'
            ,url: "/func/site/guide_content_manage?pa=1&pid={{$pid}}"
            ,cellMinWidth: 200
            ,cols: [[
                ...
                ,{width:120, align:'center', fixed: 'right', title: '操作', templet: function(d){
                        ...
                        return [
                            '<a onclick="openWindow('+ "'["+d.name+"]编辑'" +',' + "'/func/site/save_guide_content?pid={{$pid}}&id="+ d.id + '\');" class="layui-btn layui-btn-xs layui-btn-normal">编辑</a>',
    ...
    function del(id){
        ...
        layer.confirm('确认要删除该内容吗？',{
            ...
            $.ajax({
                url:"/func/site/del_guide_content",
                method:'post',
