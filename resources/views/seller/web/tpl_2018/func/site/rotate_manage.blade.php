            ...
            <div class="layui-card">
                <div class="layui-card-body" style="background:#fff;padding:10px;">
                    <div class="layui-btn-group test-table-operate-btn" style="margin-bottom: 10px;">
                        <button class="layui-btn layui-btn-normal" onclick="openWindow('添加轮播图','/func/site/save_rotate');">添加轮播图</button>
...
<script>
    layui.config({
        ...
        table.render({
            elem: '#mainTable'
            ,url: "/func/site/rotate_manage?pa=1"
            ,cellMinWidth: 200
            ,cols: [[
                ...
                ,{width:120, align:'center', fixed: 'right', title: '操作', templet: function(d){
                        return [
                            '<a onclick="openWindow('+ "'["+d.title+"]编辑'" +',' + "'/func/site/save_rotate?id="+ d.id + '\');" class="layui-btn layui-btn-xs layui-btn-normal">编辑</a>',
    ...
    function del(id){
        ...
        layer.confirm('确认要删除该轮播吗？',{
            btn:['删除','取消']
        }, function(){
            $.ajax({
                url:"{{url('/func/site/del_rotate')}}",
                method:'post',
