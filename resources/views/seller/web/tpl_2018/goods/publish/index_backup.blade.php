                    ...
                    <div class="simple-form-field">
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label">
                                <span class="ng-binding">跨境类别：</span>
                            </label>
                            <div class="col-sm-9">
                                <div class="form-control-box">
                                    <select id="goodsmodel-crossb_cate" class="form-control chosen-select" name="GoodsModel[crossb_cate]">
                                        <option value="1">普通货物</option>
                                        <option value="2">敏感货物</option>
                                        <option value="3">禁限货物</option>
                                    </select>
