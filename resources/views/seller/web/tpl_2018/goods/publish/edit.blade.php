        ...
        <div class="content m-t-30">
            <div class="goods-info-two">
                <form id="GoodsModel" class="form-horizontal" name="GoodsModel" action="/goods/publish/edit?id={{ $goods_info['goods_id'] }}" method="POST">
                            ...
                            <div class="col-sm-9">
                                <div class="form-control-box">
                                    <label class="control-label cur-p m-r-10">
                                        <input type="radio" value="0"  @if($goods_info['goods_mode'] == 0)
                                                    checked="checked"
                                                @else
                                                    disabled="disabled"
                                                @endif>
                                    ...
                                    <label class="control-label cur-p m-r-10">
                                        <input type="radio" value="1"  @if($goods_info['goods_mode'] == 1)
                                                    checked="checked"
                                                @else
                                                    disabled="disabled"
                                                @endif>
                                    ...
                                    <label class="control-label cur-p m-r-10">
                                        <input type="radio" value="2" @if($goods_info['goods_mode'] == 2)
                                                    checked="checked"
                                               @else
                                                    disabled="disabled"
                                                @endif>
                            ...
                            <div class="col-sm-11 disf">
                                <div class=" cat_div1 cat_div disf">
                                    <select id="goodsmodel-sale_cate" class="form-control chosen-select" name="GoodsModel[sale_cate1]" onchange="sale_cate1(this,1)">
                                        ...
                                        @foreach($sale_cate as $k=>$v)
                                            <option value="{{$v['cat_id']}}" @if($v['cat_id']==$goods_info['cat_id1'])
                                                selected
                                            @endif>{{$v['cat_name']}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="cat_div2 cat_div disf">
                                    @if(!empty($goods_info['cat_id2']))
                                        <select id="goodsmodel-sale_cate" class="form-control chosen-select" name="GoodsModel[sale_cate2]" onchange="sale_cate1(this,2)">
                                            <option value="">请选择</option>
                                            @foreach($all_cat_id2 as $k=>$v)
                                                <option value="{{$v['cat_id']}}" @if($v['cat_id']==$goods_info['cat_id2'])
                                                selected
                                                        @endif>{{$v['cat_name']}}</option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-11">
                                <div class="value_box goods-attr" style="display: grid;grid-template-columns: repeat(2,1fr);-moz-column-gap: 20px;column-gap: 20px;row-gap: 0px;">
                                    @foreach($goods_info['other_attrs']['value_name'.$goods_info['cat_id']] as $key=>$val)
                                    <div class="simple-form-field other-attrs-item">
                                        <div class="form-group" style="margin-left:0;margin-right:0;display:flex;align-items:center;margin-bottom:0;">
                                                      ...
                                                      <div class="value_div">
                                                           <label>
                                                                 <select name="sale_cate[value_name][]" class="goodsmodel-value_name form-control chosen-select" onchange="value_change(this,1)">
                                                                    ...
                                                                    @foreach($sale_value_selected as $k=>$v)
                                                                        <option value="{{$v['id']}}" @if($val==$v['id'])
                                                                            selected
                                                                        @endif>{{$v['name']}}</option>
                                                                    @endforeach
                                                                 </select>
                                            ...
                                            <div class="form-control-box control-label" style="float:unset;">
                                                <div class="value_desc" style="display: inline-block;">
                                                    <label>
                                                        <select name="sale_cate[value_desc][]" class="goodsmodel-value_desc form-control chosen-select" onchange="valuedesc_change(this)">
                                                            <option value="0">-- 请选择属性描述 --</option>
                                                            <option value="-1">自定义属性描述</option>
                                                            @foreach($goods_info['other_attrs']['value_desc'.$val] as $k=>$v)
                                                                <option value="{{$v['id']}}" @if($goods_info['other_attrs']['value_desc'.$goods_info['cat_id']][$key]==$v['id'])
                                                                selected
                                                                        @endif>{{$v['name']}}</option>
                                                            @endforeach
                                                        </select>
                            ...
                            <div class="col-sm-11">
                                <div class="form-control-box">
                                    <select id="goodsmodel-logistics_cate" class="form-control chosen-select" name="GoodsModel[logistics_cate]">
                                        <option value="1" @if($goods_info['logistics_cate']==1)
                                                selected
                                            @endif>（发货国地的）境内配送</option>
                                        <option value="2" @if($goods_info['logistics_cate']==2)
                                                selected
                                                @endif>（发货国地的）跨境集运</option>
                                    </select>
                                </div>
                                <div class="help-block help-block-t"></div>
                            </div>
                    ...
                    <!--跨境物流分类-->
                    <div class="simple-form-field cross_logi_cate" style="display: @if($goods_info['logistics_cate']==2)
                            block;
                            @else
                            none;
                            @endif">
                            ...
                            <div class="col-sm-11 disf">
                                <div class=" logicat_div1 logicat_div disf">
                                    <select id="goodsmodel-crossb_cate" class="form-control chosen-select" name="GoodsModel[crossb_cate1]" onchange="logi_cate1(this,1)">
                                        ...
                                        @foreach($logi_cate as $k=>$v)
                                            <option value="{{$v['cat_id']}}" @if($goods_info['crossb_cate1']==$v['cat_id'])
                                                selected
                                            @endif>{{$v['cat_name']}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="logicat_div2 logicat_div disf">
                                    @if(!empty($goods_info['crossb_cate2']))
                                        <select id="goodsmodel-crossb_cate" class="form-control chosen-select" name="GoodsModel[crossb_cate2]" onchange="logi_cate1(this,2)">
                                              <option value="">请选择</option>
                                            @foreach($logi_cate2 as $k=>$v)
                    ...
                    <!--跨境物流类别的属性-->
                    <div class="simple-form-field logi_value" style="display: @if($goods_info['logistics_cate']==2)
                            block;
                    @else
                            none;
                    @endif;">
                        <div class="form-group">
                            ...
                            <div class="col-sm-11">
                                <div class="value_box goods-attr" style="display: grid;grid-template-columns: repeat(2,1fr);-moz-column-gap: 20px;column-gap: 20px;row-gap: 0px;">
                                    @foreach($goods_info['other_attrs']['value_name'.$crossb_cate] as $key=>$val)
                                        <div class="simple-form-field other-attrs-item">
                                            <div class="form-group" style="margin-left:0;margin-right:0;display:flex;align-items:center;margin-bottom:0;">
                                                <label class="control-label" style="display:inline-block;">
                                                    <div class="form-control-box" style="margin-right:10px;">
                                                        <div class="value_div">
                                                            <label>
                                                                <select name="logi_cate[value_name][]" class="goodsmodel-value_name form-control chosen-select" onchange="value_change(this,2)">
                                                                    <option value="0">-- 请选择属性名称 --</option>
                                                                    <option value="-1">自定义属性名称</option>
                                                                    @foreach($logi_value_selected as $k=>$v)
                                                                        <option value="{{$v['id']}}" @if($val==$v['id'])
                                                                        selected
                                                                                @endif>{{$v['name']}}</option>
                                                                    @endforeach
                                                ...
                                                <div class="form-control-box control-label" style="float:unset;">
                                                    <div class="value_desc" style="display: inline-block;">
                                                        <label>
                                                            <select name="logi_cate[value_desc][]" class="goodsmodel-value_desc form-control chosen-select" onchange="valuedesc_change(this)">
                                                                <option value="0">-- 请选择属性描述 --</option>
                                                                <option value="-1">自定义属性描述</option>
                                                                @foreach($goods_info['other_attrs']['value_desc'.$val] as $k=>$v)
                                                                    <option value="{{$v['id']}}" @if($goods_info['other_attrs']['value_desc'.$crossb_cate][$key]==$v['id'])
                                                                    selected
                                                                            @endif>{{$v['name']}}</option>
                                                                @endforeach
                                                            </select>
                            ...
                            <div class="col-sm-9">
                                <div class="form-control-box">
                                    <select id="brand_type" name="GoodsModel[brand_type]" class="form-control chosen-select">
                                        <option value="1" @if($goods_info['brand_type']==1)
                                            selected
                                        @endif>白牌</option>
                                        <option value="2" @if($goods_info['brand_type']==2)
                                            selected
                                        @endif>有牌</option>
                                    </select>
                                    <div class="brand_div" style="display:  @if($goods_info['brand_type']==1)
                                            none
                                            @else
                                            inline-block
                                            @endif;">
                                        <select name="GoodsModel[brand_type2]" class="form-control chosen-select">
                                            <option value="1" @if($goods_info['brand_type2']==1)
                                                selected
                                            @endif>品牌</option>
                                            <option value="2" @if($goods_info['brand_type2']==2)
                                                selected
                                            @endif>名牌</option>
                                        </select>
                                        <select id="brand_id" name="GoodsModel[brand_id]" class="form-control chosen-select">
                                            @foreach($brand_list as $v)
                                                <option value="{{ $v['brand_id'] }}" @if($goods_info['brand_id']==$v['brand_id'])
                                                    selected
                                                @endif>{{ $v['brand_name'] }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="goods-attr">
                                    ...
                                    <div class="simple-form-field" >
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-control-box">
                                                    <select id="goodsmodel-is_export" class="form-control chosen-select" name="GoodsModel[is_export]" @if($goods_info['crossborder_cate']['prohibit_cate']==2)
                                                        readonly
                                                    @endif>
                                                        <option value="1" @if($goods_info['crossborder_restrict']['is_export']==1)
                                                            selected
                                                        @endif>是</option>
                                                        <option value="2" @if($goods_info['crossborder_restrict']['is_export']==2)
                                                            selected
                                                        @endif>否</option>
                                                    </select>
                                                </div>
                                                <div class="help-block help-block-t"><div class="help-block help-block-t"><span class="support_export">@if($goods_info['crossborder_restrict']['is_export']==1)
                                                    支持
                                                @else
                                                    不支持
                                                @endif</span>外币结算、跨境集运；</div></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="goodsmodel-goods_attr" class="col-sm-2 control-label">
                                ...
                                <div class="goods-attr">
                                    ...
                                    <div class="simple-form-field" >
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-11">
                                                <div class="form-control-box">
                                                    <select id="goodsmodel-is_gather" class="form-control chosen-select" name="GoodsModel[is_gather]" @if($goods_info['crossborder_cate']['prohibit_cate']==2)
                                                        readonly
                                                    @endif>
                                                        <option value="1" @if($goods_info['crossborder_restrict']['is_gather']==1)
                                                            selected
                                                        @endif>支持跨境集运</option>
                                                        <option value="2" @if($goods_info['crossborder_restrict']['is_gather']==2)
                                                            selected
                                                        @endif>不能跨境集运</option>
                                                    </select>
                                                </div>
                                ...
                                <div class="goods-attr">
                                    ...
                                    <div class="simple-form-field" >
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-11">
                                                <div class="form-control-box">
                                                    <select id="goodsmodel-is_outcurrency" class="form-control chosen-select" name="GoodsModel[is_outcurrency]" @if($goods_info['crossborder_cate']['prohibit_cate']==2)
                                                        readonly
                                                    @endif>
                                                        <option value="1" @if($goods_info['crossborder_restrict']['is_outcurrency']==1)
                                                            selected
                                                        @endif>支持外币结算</option>
                                                        <option value="2" @if($goods_info['crossborder_restrict']['is_outcurrency']==2)
                                                            selected
                                                        @endif>不能外币结算</option>
                                                    </select>
                                                </div>
                                                <div class="help-block help-block-t"><div class="help-block help-block-t">@if($goods_info['crossborder_restrict']['is_outcurrency']==1)
                                                            支持 <span class="support_currency">本币聚合支付、外币聚合支付</span>；
                                                        @else
                                                            支持 <span class="support_currency">本币聚合支付</span>；
                                                        @endif
                                                    </div></div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-control-box">
                                    ...
                                    <div class="goods-attr w800" data-anchor="商品属性">
                                        ...
                                        <div class="other-attrs-list">
                                            @if(isset($goods_info['other_attrs']['value_name'][0]))
                                                @foreach($goods_info['other_attrs']['value_name'] as $k2=>$v2)
                                                    <div class="simple-form-field other-attrs-item">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7" style="width: 63%;">
                                                                <div class="form-control-box control-label">
                                                                    <div class="value_desc" style="display: inline-block;">
                                                                        <label>
                                                                            <select name="GoodsModel[value_desc][]" class="goodsmodel-value_desc form-control chosen-select" onchange="valuedesc_change(this)">
                                                                                <option value="0">-- 请选择属性描述 --</option>
                                                                                <option value="-1">自定义属性描述</option>
                                                                                @foreach($goods_info['other_attrs']['child_value'][$k2] as $k=>$v)
                                                                                    <option value="{{$v['id']}}" @if($v['id']==$goods_info['other_attrs']['value_desc'][$k2])
                                                                                    selected
                                                                                            @endif>{{$v['name']}}</option>
                                                                                @endforeach
                                                                            </select>
                    ...
                    <div class="simple-form-field">
                        <div class="form-group">
                            ...
                            <div class="col-sm-11">
                                <div class="form-control-box">
                                    <div class="goods-attr type1 w800">
                                        <div class="goods-attr-tit">
                                            <span>用户价格说明</span>
                                        </div>
                                        <div class="simple-form-field">
                                            <div class="input40">
                                                @if(!empty($goods_info['userprice_intro'][0]['title']) && !empty($goods_info['userprice_intro'][0]['content']))
                                                    <input type="hidden" id="big_parag_num" value="{{$goods_info['userprice_introNum']}}">
                                                    <div class="regular_box">
                                                        @foreach($goods_info['userprice_intro'] as $k=>$vo)
                                                        <!--手风琴-->
                                                                ...
                                                                <div class="layui-collapse" lay-accordion="">
                                                                    <div class="layui-colla-item">
                                                                        <h2 class="layui-colla-title">
                                                                            <div class="disf">
                                                                                <input type="text" name="parag_num2[]" class="layui-input parag_num" value="{{$vo['parag_num']}}" readonly>
                                                                                <input type="hidden" class="layui-input" name="pnum2[]" value="{{$vo['pnum']}}">
                                                                                @if($vo['is_title']==1)
                                                                                    <input type="hidden" class="layui-input" name="is_title2[]" value="1">
                                                                                    <input type="text" class="layui-input" name="title2[]" placeholder="输入标题" value="{{$vo['title']}}">
                                                                                @elseif($vo['is_title']==-1)
                                                                                    <select name="is_title2[]" lay-filter="is_title" style="display: none;">
                                                                                        <option value="-1" selected>不需要标题</option>
                                                                                        <option value="1">需要标题</option>
                                                                                    </select>
                                                                                    <input type="text" class="layui-input title" name="title2[]" placeholder="输入标题" value="{{$vo['title']}}" style="display: none;">
                                                                                @endif
                                                                        ...
                                                                        <div class="layui-colla-content">
                                                                            <textarea name="content2[]" class="layui-textarea" placeholder="输入内容" onkeyup="keyup2(this)">{{$vo['content']}}</textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-11">
                                <select name="have_specs" id="have_specs" class="form-control chosen-select">
                                    <option value="1" @if($goods_info['have_specs']==1)
                                        selected
                                    @endif>有规格型号</option>
                                    <option value="2" @if($goods_info['have_specs']==2)
                                        selected
                                    @endif>无规格型号</option>
                                </select>
                                <div class="nohave_specs form-control-box" style="display:@if($goods_info['have_specs']==2)
                                            block
                                        @else
                                            none
                                        @endif;width: 100%;margin-top:10px;">
                                    <!--无规格型号-->
                                    <table id="sku_tableno" class="table table-hover">
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" name="nospecs[goods_number][]" value="{{$goods_info['goods_number']}}" class="form-control small sku-field sku-goods-number" data-rule-required="" data-msg-required="SKU商品库存不能为空" data-rule-min="0" data-rule-max="9999999">
                                            </td>
                                            <td colspan="3">
                                                <table class="spec_table" style="width:100%;text-align:center;">
                                                    @if(!empty($goods_info['nospecs']['price'][0]))
                                                        @foreach($goods_info['nospecs']['start_num'] as $kk=>$vv)
                                                            <tr>
                                                                <td class="td_width">
                                                                    <div class="disf">
                                                                        <input type="number" name="nospecs[start_num][]" value="{{$vv}}" class="form-control w50 start_num" placeholder="起始数值">
                                                                        <select name="nospecs[unit][]" class="form-control chosen-select unit" onchange="specs_unit(this)">
                                                                            <option value="">请选择</option>
                                                                            @foreach($unit as $k=>$v)
                                                                                <option value="{{$v['code_value']}}" data-title="{{$v['code_name']}}" @if($goods_info['nospecs']['unit'][$kk]==$v['code_value'])
                                                                                    selected
                                                                                @endif>{{$v['code_name']}}</option>
                                                                            @endforeach
                                                                        </select>
                                                                        至
                                                                        <select name="nospecs[select_end][]" class="form-control chosen-select " onchange="specs_selEnd(this)">
                                                                            <option value="1" @if($goods_info['nospecs']['select_end'][$kk]==1)
                                                                                selected
                                                                            @endif>数值</option>
                                                                            <option value="2" @if($goods_info['nospecs']['select_end'][$kk]==2)
                                                                                selected
                                                                            @endif>以上</option>
                                                                        </select>
                                                                        <input type="number" name="nospecs[end_num][]" value="{{$goods_info['nospecs']['end_num'][$kk]}}" class="form-control w50 end_num" placeholder="尾止数值" style="display:@if($goods_info['nospecs']['select_end'][$kk]==1)
                                                                                block
                                                                                @else
                                                                                none
                                                                                @endif;">
                                                                        <div class="unit_name">
                                                                            @foreach($unit as $k=>$v)
                                                                                @if($goods_info['nospecs']['unit'][$kk]==$v['code_value']){{$v['code_name']}}@endif
                                                                            @endforeach
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="td_width">
                                                                    <select name="nospecs[currency][]" class="form-control chosen-select currency" onchange="specs_currency(this)">
                                                                        ...
                                                                        @foreach($currency as $k=>$v)
                                                                            <option value="{{$v['id']}}" data-title="{{$v['currency_symbol_origin']}}" @if($v['id']==$goods_info['nospecs']['currency'][$kk])
                                                                            selected
                                                                                    @endif>{{$v['code_zhname']}}：{{$v['currency_symbol_origin']}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    <input type="number" name="nospecs[price][]" value="{{$goods_info['nospecs']['price'][$kk]}}" class="form-control w70" placeholder="区间金额">
                                                                </td>
                                                                <td style="text-align:center;display:
                                                                    @if(isset($goods_info['nospecs']['start_num'][$kk+1]))
                                                                    none
                                                                    @else
                                                                    block
                                                                    @endif;">
                                ...
                                <div class="have_specs form-control-box" style="display:@if($goods_info['have_specs']==1)
                                        block
                                        @else
                                        none
                                        @endif;width: 100%;margin-top:10px;">
                        ...
                        <div class="col-sm-9">
                            <div class="form-control-box">
                                    ...
                                    <div class="simple-form-field" >
                                            ...
                                            <div class="col-sm-9">
                                                <div class="form-control-box">
                                                    ...
                                                    <select id="goodsmodel-full_buycurrency" class="form-control chosen-select" name="GoodsModel[full_buy_currency]">
                                                        @foreach($currency as $k=>$v)
                                                            <option value="{{$v['id']}}" @if($v['id']==$goods_info['platform_preferent']['full_buy_currency'])
                                                            selected
                                                                    @endif data-title="{{$v['currency_symbol_origin']}}">{{$v['code_zhname']}}:{{$v['currency_symbol_origin']}}</option>
                                                        @endforeach
                                                    </select>
                                                    <input type="number" class="form-control w50" name="GoodsModel[full_buy_price]" data-anchor="买满金额" value="{{$goods_info['platform_preferent']['full_buy_price']}}">
                                                    &nbsp;减&nbsp;
                                                    <div class="currency_name" style="display: inline-block;width: fit-content;">
                                                        @foreach($currency as $k=>$v)
                                                            @if($v['id']==$goods_info['platform_preferent']['full_buy_currency']){{$v['currency_symbol_origin']}}@endif
                                                        @endforeach
                                                    </div>&nbsp;
                                                    <input type="number" class="form-control w50" name="GoodsModel[full_buy_minusprice]" data-anchor="减除金额" value="{{$goods_info['platform_preferent']['full_buy_minusprice']}}">
                                                </div>
                                                <div class="form-control-box" style="margin-top:10px;">
                                                    买满&nbsp;
                                                    <input type="number" class="form-control w50" name="GoodsModel[full_buy_num]" data-anchor="买满数值" value="{{$goods_info['platform_preferent']['full_buy_num']}}">
                                                    <select id="goodsmodel-full_buyunit" class="form-control chosen-select" name="GoodsModel[full_buy_unit]">
                                                        @foreach($unit as $k=>$v)
                                                            <option value="{{$v['code_value']}}" @if($v['code_value']==$goods_info['platform_preferent']['full_buy_unit'])
                                                                selected
                                                            @endif>{{$v['code_name']}}</option>
                                                        @endforeach
                                                    </select>
                                                    &nbsp;送&nbsp;
                                                    <input type="number" class="form-control w50" name="GoodsModel[full_buy_deliverynum]" data-anchor="赠送数值" value="{{$goods_info['platform_preferent']['full_buy_deliverynum']}}">&nbsp;
                                                    <div class="unit_name" style="display: inline-block;width: fit-content;">
                                                        @foreach($unit as $k=>$v)
                                                            @if($v['code_value']==$goods_info['platform_preferent']['full_buy_unit']){{$v['code_name']}}@endif
                                                        @endforeach
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="form-control-box">
                                                    <div class="shiwu_div">
                                                        @foreach($goods_info['platform_preferent']['shiwu_desc'] as $k=>$v)
                                                            <div class="disf">
                                                                <input type="text" class="form-control" name="GoodsModel[shiwu_desc][]" placeholder="请输入描述" value="{{$v}}">
                                                                @if($k!=0)
                                                                    <div class="layui-btn layui-btn-md layui-btn-danger shiwu_del" onclick="shiwu_del(this,1)" style="display:@if(isset($goods_info['platform_preferent']['shiwu_desc'][$k+1]))
                                                                        none
                                                                    @else
                                                                        block
                                                                    @endif;">-</div>
                                                                @endif
                                                                <div class="layui-btn layui-btn-md layui-btn-normal shiwu_add" onclick="shiwu_add(this)" style="display:@if(isset($goods_info['platform_preferent']['shiwu_desc'][$k+1]))
                                                                        none
                                                                @else
                                                                        block
                                                                @endif;">+</div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="form-control-box">
                                                    <div class="fuwu_div">
                                                        @foreach($goods_info['platform_preferent']['fuwu_desc'] as $k=>$v)
                                                        <div class="disf">
                                                            <input type="text" class="form-control" name="GoodsModel[fuwu_desc][]" placeholder="请输入描述" value="{{$v}}">
                                                            @if($k!=0)
                                                                <div class="layui-btn layui-btn-md layui-btn-danger shiwu_del" onclick="shiwu_del(this,2)" style="display:@if(isset($goods_info['platform_preferent']['fuwu_desc'][$k+1]))
                                                                        none
                                                                @else
                                                                        block
                                                                @endif;">-</div>
                                                            @endif
                                                            <div class="layui-btn layui-btn-md layui-btn-normal fuwu_add" onclick="fuwu_add(this)" style="display:@if(isset($goods_info['platform_preferent']['fuwu_desc'][$k+1]))
                                                                    none
                                                            @else
                                                                    block
                                                            @endif;">+</div>
                                ...
                                <div class="goods-attr w800">
                                    ...
                                    <div class="simple-form-field">
                                        @foreach($goods_info['merchant_valueadd']['valueadd_name'] as $k=>$v)
                                            <div class="valueadd_div">
                                                <input type="text" class="form-control w100" name="GoodsModel[valueadd_name][]" placeholder="请输入增值服务名称" value="{{$v}}">
                                                <input type="text" class="form-control w300" name="GoodsModel[valueadd_desc][]" placeholder="请输入增值服务描述" value="{{$goods_info['merchant_valueadd']['valueadd_desc'][$k]}}">
                                                <div class="layui-btn layui-btn-md layui-btn-danger value_del" onclick="shiwu_del(this,3)" style="display:@if(isset($goods_info['merchant_valueadd']['valueadd_desc'][$k+1]))
                                                        none
                                                @else
                                                        inline-block
                                                @endif;">-</div>
                                                <div class="layui-btn layui-btn-md layui-btn-normal value_add" onclick="value_add(this)" style="display:@if(isset($goods_info['merchant_valueadd']['valueadd_desc'][$k+1]))
                                                        none
                                                @else
                                                        inline-block
                                                @endif;">+</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="form-control-box">
                                    ...
                                    <!-- 视频相对路径 -->
                                    <input type="text" id="goodsmodel-goods_video" class="form-control" name="GoodsModel[goods_video]" value="{{ $goods_info['goods_video'] }}" style="display: none;">
                                    <input type="text" id="goodsmodel-goods_video2" class="form-control" name="GoodsModel[goods_video2]" value="{{ $goods_info['goods_video'] }}" style="display: none;">
                            ...
                            <div class="col-sm-9">
                                <div class="form-control-box">
                                    <select id="goodsmodel-have_activity" class="form-control chosen-select" name="GoodsModel[have_activity]">
                                        <option value="1" @if($goods_info['activity_info']['have_activity']==1)
                                            selected
                                        @endif>参与活动</option>
                                        <option value="2" @if($goods_info['activity_info']['have_activity']==2)
                                            selected
                                        @endif>不参与活动</option>
                                    </select>
                                    <div id="activity_id" class="xm-select-demo" style="width:150px;margin-top:10px;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="form-control-box">
                                    <div class="changwei_div">
                                        <div class="form-group brand_promote">
                                            ...
                                            <div class="">
                                                <div class="form-control-box">
                                                    @foreach($goods_info['promotion_text']['shihe_brandname'] as $k=>$v)
                                                        <div class="note">{{$v}}<input name="GoodsModel[shihe_changwei][brandname][]" value="{{$v}}" style="display:none;"></div>
                                                    @endforeach
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group gcate_promote">
                                            ...
                                            <div class="">
                                                <div class="form-control-box">
                                                    @foreach($goods_info['promotion_text']['shihe_gcate'] as $k=>$v)
                                        ...
                                        <div class="form-group gname_promote">
                                            ...
                                            <div class="">
                                                <div class="form-control-box">
                                                    @foreach($goods_info['promotion_text']['shihe_goodsname'] as $k=>$v)
                                                        <div class="note">{{$v}}<input name="GoodsModel[shihe_changwei][goodsname][]" value="{{$v}}" style="display:none;"></div>
                                                    @endforeach
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group gattr_promote">
                                            ...
                                            <div class="">
                                                <div class="form-control-box">
                                                    @foreach($goods_info['promotion_text']['shihe_gattr_promote'] as $k=>$v)
                                                        <div class="note">{{$v}}<input name="GoodsModel[shihe_changwei][gattr_promote][]" value="{{$v}}" style="display:none;"></div>
                                                    @endforeach
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group goption_promote">
                                            ...
                                            <div class="">
                                                <div class="form-control-box">
                                                    @if(!empty($goods_info['promotion_text']['shihe_goption']))
                                                        @foreach($goods_info['promotion_text']['shihe_goption'] as $k=>$v)
                                                            <div class="note">{{$v}}<input name="GoodsModel[shihe_changwei][goption][]" value="{{$v}}" style="display:none;"></div>
                                                        @endforeach
                                                    @endif
                                                </div>
                                            </div>
    ...
    <script type='text/javascript'>
        ...
        $().ready(function() {
            ...
            let renqun = xmSelect.render({
                ...
                height: '300px', //最大下拉框高度
                data: {!! $shihe['renqun'] !!},
                initValue:[{{$goods_info['promotion_text']['shihe_renqun']}}],
            });
            //适合国家
            let country = xmSelect.render({
                ...
                height: '300px', //最大下拉框高度
                data: {!! $shihe['country'] !!},
                initValue:[{{$goods_info['promotion_text']['shihe_country']}}],
            });
            //适合网媒
            let media = xmSelect.render({
                ...
                height: '300px', //最大下拉框高度
                data: {!! $shihe['media'] !!},
                initValue:[{{$goods_info['promotion_text']['shihe_media']}}],
            });
            //适用节日
            let festival = xmSelect.render({
                ...
                height: '300px', //最大下拉框高度
                data: {!! $shihe['festival'] !!},
                initValue:[{{$goods_info['promotion_text']['shihe_festival']}}],
            });
            //适用同款
            let common_goods = xmSelect.render({
                ...
                initValue:[{{$goods_info['promotion_text']['shihe_commongoods']}}],
            });
            //适用宗教
            let zongjiao = xmSelect.render({
                ...
                height: '300px', //最大下拉框高度
                data: {!! $shihe['zongjiao'] !!},
                initValue:[{{$goods_info['promotion_text']['shihe_zongjiao']}}],
            });
            //===2024-01-16 END===
    ...
    <script type='text/javascript'>
        ...
        $().ready(function() {
            ...
            evalSkuTable = function(init) {
                ...
                var template = '<tr><td class="sku-td-index text-c"></td>\n' +
                    '        <td>\n'+
                ...
                let arr = Object.entries(sku_object);
                for (var i = 0; i < list.length; i++) {
                    ...
                    var html = "";
                    if(sku_object!=''){
                        if(typeof(arr[i][1]['sku_prices']) != 'undefined') {
                            html = '<tr><td class="sku-td-index text-c"></td>\n' +
                                '                    <td>\n'+
                                '                        <input type="number" name="new_specs[goods_number][]" value="'+arr[i][1]['sku_prices']['goods_number']+'" class="form-control small sku-field2 sku-goods-number" data-msg-required="SKU商品库存不能为空" data-rule-min="0" data-rule-max="9999999">\n'+
                                '                    </td>\n'+
                                '        <td colspan="3">\n' +
                                '            <table class="spec_table" style="width:100%;text-align:center;">\n';

                            for (let j = 0; j < arr[i][1]['sku_prices']['start_num'].length; j++) {//3,2,1,1
                                // console.log('循环第'+(i+1)+'次的内'+(j+1)+'次');
                                html += '        <tr>\n' +
                                    '                    <td class="td_width">\n' +
                                    '                        <div class="disf">\n' +
                                    '                            <input type="number" name="new_specs[start_num][tr_num][]" value="' + arr[i][1]['sku_prices']['start_num'][j] + '" class="form-control w50 start_num" placeholder="起始数值">\n' +
                                    '                            <select name="new_specs[unit][tr_num][]" class="form-control chosen-select unit" onchange="specs_unit(this)">\n' +
                                    '                                <option value="">请选择</option>\n';
                                @foreach($unit as $k=>$v)
                                if (arr[i][1]['sku_prices']['unit'][j] == "{{$v['code_value']}}") {
                                    html += '                            <option value="{{$v['code_value']}}" data-title="{{$v['code_name']}}" selected>{{$v['code_name']}}</option>\n';
                                } else {
                                    html += '                            <option value="{{$v['code_value']}}" data-title="{{$v['code_name']}}">{{$v['code_name']}}</option>\n';
                                }
                                @endforeach
                                    ...
                                    '                            至\n' +
                                    '                            <select name="new_specs[select_end][tr_num][]" class="form-control chosen-select " onchange="specs_selEnd(this)">\n';
                                if (arr[i][1]['sku_prices']['select_end'][j] == 1) {
                                    html += '                                <option value="1" selected>数值</option>\n';
                                } else {
                                    html += '                                <option value="1">数值</option>\n';
                                }
                                if (arr[i][1]['sku_prices']['select_end'][j] == 2) {
                                    html += '                                <option value="2" selected>以上</option>\n';
                                } else {
                                    html += '                                <option value="2">以上</option>\n';
                                }
                                html += '                            </select>\n';
                                if (arr[i][1]['sku_prices']['select_end'][j] == 2) {
                                    html += '                            <input type="number" name="new_specs[end_num][tr_num][]" value="' + arr[i][1]['sku_prices']['end_num'][j] + '" class="form-control w50 end_num" placeholder="尾止数值" style="display:none;">\n';
                                } else {
                                    html += '                            <input type="number" name="new_specs[end_num][tr_num][]" value="' + arr[i][1]['sku_prices']['end_num'][j] + '" class="form-control w50 end_num" placeholder="尾止数值">\n';
                                }
                                html += '                            <div class="unit_name">';
                                @foreach($unit as $k=>$v)
                                if (arr[i][1]['sku_prices']['unit'][j] == "{{$v['code_value']}}") {
                                    html += "{{$v['code_name']}}";
                                }
                                @endforeach
                                    ...
                                    '                            <option value="">请选择</option>\n';
                                @foreach($currency as $k=>$v)
                                if ("{{$v['id']}}" == arr[i][1]['sku_prices']['currency'][j]) {
                                    html += '                        <option value="{{$v['id']}}" data-title="{{$v['currency_symbol_origin']}}" selected>{{$v['code_zhname']}}：{{$v['currency_symbol_origin']}}</option>\n';
                                } else {
                                    html += '                        <option value="{{$v['id']}}" data-title="{{$v['currency_symbol_origin']}}">{{$v['code_zhname']}}：{{$v['currency_symbol_origin']}}</option>\n';
                                }
                                @endforeach
                                    html += '              </select>\n' +
                                    '                        <input type="number" name="new_specs[price][tr_num][]" value="' + arr[i][1]['sku_prices']['price'][j] + '" class="form-control w70" placeholder="区间金额">\n' +
                                    '                    </td>\n';
                                if (typeof (arr[i][1]['sku_prices']['currency'][j + 1]) == 'undefined') {
                                    html += '              <td style="text-align:center;">\n';
                                } else {
                                    html += '              <td style="text-align:center;display: none;">\n';
                                }
                                if (j != 0) {
                                    html += '                        <div class="layui-btn layui-btn-md layui-btn-danger delbtn" onclick="del_interval(this)">-</div>\n';
                                }
                                html += '                        <div class="layui-btn layui-btn-md layui-btn-normal addbtn" onclick="add_interval(this,tr_num)">+</div>\n' +
                                    '                    </td>\n' +
                                    '                </tr>\n';
                            }
                            html += '     </table>\n' +
