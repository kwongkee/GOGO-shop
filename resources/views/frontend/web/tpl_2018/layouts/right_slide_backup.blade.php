...
<style>
    ...
    .windowBox{display: none;position: fixed;top:50%;left:50%;transform: translate(-50%,-50%);z-index: 20;width: 950px;height:635px;border:2px solid #1f5188;box-shadow: 0px 0px 8px 0px #797777;border-radius: 25px;background:#fff;box-sizing: border-box;}
    ...
    .windowBox .rightBox{width: 71%;height:100%;background:#1f5188;border-bottom-right-radius: 25px;}
    ...
    .windowBox .rightBox .levelList1 .levelItem{padding:10px 39.85px;font-size: 18px;font-weight:800;display: table-cell;color:#fff;background:#1f5188;border-right:1px solid #fff;cursor: pointer;white-space: nowrap;box-sizing: border-box;}
    ...
    .windowBox .windowContent .newsDiv .icon:after{content:'';position: absolute;right: -14px;top: 1px;width: 1px;height: 18px;background: #1f5188;}
    ...
    .windowBox .windowContent .newsDiv .newsContent .cont7 a{font-size: 15px;color:#1f5188;display: -webkit-box;-webkit-box-orient: vertical;-webkit-line-clamp: 1;overflow: hidden;text-overflow: ellipsis;}
</style>
...
<div class="fuchuang left-contents startFace" style="display: none;">
    <div class="leftList">
        ...
        <div class="leftCont">
            @foreach($website['leftFrame'] as $k=>$v)
                ...
                @if($k==0)
                    <div class="turnDown" onclick="checkStartFace(this)">
                        <img src="/assets/d2eace91/images/newhome/turndown.png" alt="">
                    </div>
                @endif
            @endforeach
        </div>
...
<div class="windowBox">
    <div class="close" onclick="closeWindows()"><img src="/assets/d2eace91/images/newhome/close.png" alt=""></div>
    <div class="windowDiv disf" style="align-items: flex-start;">
        ...
        <div class="rightBox">
            ...
            <div class="windowContent">
                ...
                <div class="newsDiv" style="display: none;">
                    <div class="disf">
                        <div class="icon"><img src="/assets/d2eace91/images/newhome/gantan.png" alt=""></div>
                        <div class="newsContent">
                            <div class="swiper-container cont7">
                                <div class="swiper-wrapper">
                                    foreach($news as $k=>$v)
                                    <div class="swiper-slide">
                                        <a href="/news_detail?id=$v['id']"><p>$v['title']</p></a>
                                    </div>
                                    endforeach
                                </div>
                            </div>
...
<script>
    ...
    function showWindows(id,type,t){
        checkStartFace(t);
        layer.load();
        $.post('/getFrame',{'id':id,'type':type,'_token':'{{csrf_token()}}'},function(res){
            let list = res.list;
