...
<style>
    ...
    .windowBox{display: none;position: fixed;top:50%;left:50%;transform: translate(-50%,-50%);z-index: 20;width: 950px;height:635px;border:2px solid {{$website['color']}};box-shadow: 0px 0px 8px 0px #797777;border-radius: 25px;background:#fff;box-sizing: border-box;}
    ...
    .windowBox .windowContent .newsDiv .icon:after{content:'';position: absolute;right: -14px;top: 1px;width: 1px;height: 18px;background: {{$website['color']}};}
