...
@section('content')
    ...
    <style type="text/css" media="all">
        ...
        .title{font-size:25px;font-weight:600;color:{{$website['fontcolor']}};text-align:center;margin-bottom:18px;}

        .non_topimg{background:{{$website['background']}};}
        #content{padding:120px 0 40px;}
        #content .container .content{border: 1px solid {{$website['fontcolor']}};background:{{$website['content']}};padding:30px 20px 60px;box-sizing:border-box;position:relative;margin-top:10px;box-shadow: 0px 0px 8px 1px #dfdede;}
        ...
        #content .container .content .contents{z-index:2;position:relative;color:{{$website['fontcolor']}};font-size: 20px;overflow-y:scroll;width: 100%;height:650px;}
        #content .container .content .contents p{white-space: pre-wrap !important;}
        #content .container .content .contents p span{white-space: pre-wrap !important;}
        ...
        .color_word_box{background:{{$news['color']}} !important;color:{{$news['word_color']}};width:500px;height:280px;}
        ...
        @media (max-width: 992px){
            ...
            .color_word_box{background:{{$news['color']}} !important;color:{{$news['word_color']}};width:100%;height:280px;}
        }
        ...
        <div class="w1200">
            ...
            <div class="container" style="padding-top:0;">
                ...
                <div class="content" >
                    ...
                    <div class="contents">
                        @if($news['avatar_location']==1)
                        <div class="" style="text-align:center;">
                            @if($news['format']==1 && isset($news['thumb']))
                            <img class="main_img" src="https://shop.gogo198.cn/{{$news['thumb']}}" alt="" />
                            @elseif($news['format']==2 && isset($news['color']))
                            <div class="color_word color_word_box">{{$news['color_word']}}</div>
                            @endif
                        </div>
                        @endif
                        {!! $news['content'] !!}
                        @if($news['avatar_location']==2)
                            <div class="" style="text-align:center;">
                                @if($news['format']==1 && isset($news['thumb']))
                                    <img class="main_img" src="https://shop.gogo198.cn/{{$news['thumb']}}" alt="" />
                                @elseif($news['format']==2 && isset($news['color']))
    ...
    <script>
        ...
        $(function(){
            let link = "{{$news['link']}}";
            let html = '<a href="'+link+'" style="display:none;">' +
