...
@section('content')
    ...
    <style type="text/css" media="all">
        ...
        #content{padding:20px;background:{{$website['background']}};/**height:630px;**/}
                                                ...
                                                <div class="layui-colla-content">
                                                    @foreach($vo['children'] as $key2 => $vo2)
                                                        <div class="disf rule_div">
                                                            <div class="left_title">{{$vo2['name']}}</div>
                                                            <div class="right_btn">
                                                                <a href="{{$vo2['link']}}" class="f15 layui-btn layui-btn-primary layui-btn-xs" target="_blank" style="background:unset;border:1px solid {{$website['fontcolor']}};color:{{$website['fontcolor']}};font-size: 15px !important;">打开</a>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                </div>
