...
@section('content')
    ...
    <style type="text/css" media="all">
        ...
        #content{padding-top:120px;padding-bottom:40px;background:{{$website['background']}};}
        ...
        .content .box_content{background:{{$website['content']}};color:{{$website['fontcolor']}};border:1px solid {{$website['fontcolor']}};font-size:25px;text-align:center;padding:30px;width:100%;}
        ...
        .context,.navbar_menu a{color:{{$website['fontcolor']}};}
                    ...
                    <div class="layui-fluid" style="padding:0;">
                        <div class="layui-row layui-col-space15">
                            <div class="layui-col-md12" style="padding:0;">
                                <p class="navbar_menu"><i class="fa fa-sign-in" style="margin-right:5px;display:none;"></i><a href="/">HOME</a>&nbsp;<span style="color:{{$website['fontcolor']}};">\</span>&nbsp;<a href="/rule_list" style="color:{{$website['fontcolor']}};">平台规则</a>&nbsp;<span style="color:{{$website['fontcolor']}};">\</span>&nbsp;<a href="/version_list?pid={{$data['id']}}" style="color:{{$website['fontcolor']}};">{{$data['rule_name']}}</a>&nbsp;<span style="color:{{$website['fontcolor']}};">\</span>&nbsp;<span>{{$data['version']}}</span></p>
                                <div class="row" style="width:100%;margin:0 auto;">
                                    <div class="col-md-12">
                                        <div style="border:1px solid {{$website['fontcolor']}};height: 650px;overflow-y: scroll;padding:0 10px;box-sizing:border-box;">
                                            <!--序言头部-->
                                            ...
                                            @if($data['type']==1)
                                                <div class="layui-collapse" lay-accordion="now" style="margin:10px 0;">
                                                    @foreach($data['content2'] as $key=>$vo)
                        ...
                        @if(!empty($footerInfo['link']))
                            <a href="{{$footerInfo['link']}}" target="_blank">
                                <div class="need_service">
                                    <i class="fa fa-location-arrow" style="color:{{$website['fontcolor']}};font-size:15px;margin-right:3px;"></i>
                                    我要服务
                                </div>
                            </a>
                        @endif
