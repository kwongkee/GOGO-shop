...
@section('content')
    ...
    <div class="template-one">
        ...
        <div class="template-one">
            <div class="floor"></div>
            <div class="drop-item invalid" data-tpl_name="楼层版式十一" data-is_valid="">

                <!-- 楼层 _start -->
                <div class="w1210 shop-floor">
                    <h2 class="shop-floor-title">
                        <em style="background:;">&nbsp;</em>
                        <a href="javascript:void(0)" target="" class="shop-floor-name" style="color:;">热卖商品</a>
                        <em style="background:;">&nbsp;</em>
                        <a href="javascript:void(0)" target="" class="floor-more" style="color:;display: none;">更多 &gt;</a>
                    </h2>
                            ...
                            <li class="@if($k==0)
                                ...
                                <dl>
                                    <dt class="goods-thumb">
                                        <a target="" href="/goods-{{$v['goods_id']}}.html" title="{{$v['goods_name']}}" style="">
                                            <img class="" src="https://api.gogo198.cn/images/{{$v['goods_image']}}" data-original="https://api.gogo198.cn/images/{{$v['goods_image']}}" data-original-webp="https://api.gogo198.cn/images/{{$v['goods_image']}}" alt="{{$v['goods_name']}}" style="display: inline;">
                                        </a>
                                    </dt>
                                    <dd class="goods-info">
                                        <a target="" href="/goods-{{$v['goods_id']}}.html" title="{{$v['goods_name']}}" class="goods-name">{{$v['goods_name']}}</a>
                                        <p>
                                            <span class="goods-price color fl">{{$v['currency']}} {{$v['goods_price']}}</span>
                                            <a target="_blank" href="/goods-{{$v['goods_id']}}.html" title="立即抢购" class="shop-add-cart fr">立即抢购</a>
                                        </p>
                                    </dd>
                                </dl>
                            </li>
