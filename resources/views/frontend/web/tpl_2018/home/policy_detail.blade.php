...
@section('content')
    ...
    <style type="text/css" media="all">
        ...
        .preface{width:100%;position:relative;padding: 0 0 40px 0;box-sizing: border-box;}
        .preface .preface_title{width:80px;text-align:right;font-size:15px;color:{{$website['fontcolor']}};font-weight:600;margin-right:10px;}
        .preface .preface_title2{text-align:left;font-size:15px;color:{{$website['fontcolor']}};width:90%;}
        ...
        <div class="w1200">
            ...
            <div class="container" style="padding-top:0;">
                ...
                <div class="content" >
                    ...
                    <div class="contents">
                        <div class="preface" style="margin-top:0px;">
                            <div class="disf">
                                <div class="preface_title">发文机关</div>
                                <div class="preface_title2">{{$news['issuing_authority']}}</div>
                            </div>
                            <div class="disf">
                                <div class="preface_title">文　　号</div>
                                <div class="preface_title2">{{$news['document_number']}}</div>
                            </div>
                            <div class="disf">
                                <div class="preface_title">发布日期</div>
                                <div class="preface_title2">{{$news['release_date']}}</div>
                            </div>
                            <div class="disf">
                                <div class="preface_title">生效日期</div>
                                <div class="preface_title2">{{$news['effective_date']}}</div>
                            </div>
                            <div class="disf">
                                <div class="preface_title">效力</div>
                                <div class="preface_title2">{{$news['effect']}}</div>
                            </div>
                            @if(!empty($news['remark']))
                                <div class="disf">
                                    <div class="preface_title">备注</div>
                                    <div class="preface_title2">{{$news['remark']}}</div>
                                </div>
                            @endif
                        </div>
                        {{$news['desc']}}
    ...
    <script>
        ...
        $(function(){
            let link = "{{$news['link']}}";
            let html = '<a href="'+link+'" style="display:;" target="_blank">' +
