...
<style>
    /*.layui-layer,.SZY-LAYER-LOADING{position:fixed !important;left:50% !important;}*/
</style>
    ...
    <div class="login-con pos-r">
        ...
        <div class="login-wrap ">
            ...
            <div class="login-radio">
                <ul>
                    <li class="" id="login2" onclick="setTab('login',2,2)" style="display: none;">普通登录</li>
                    <li class="active" id="login1" onclick="setTab('login',1,2)">动态密码登录</li>
                </ul>
            </div>
            <!-- 普通登录(废弃) start -->
            ...
            <div id="con_login_1" class="form">
                <form id="form1" action="/login" method="POST">
                    ...
                    <div class="form-group item-name">
                        ...
                        <div class="form-control-box">
                            <i class="icon"></i>
                            <input type="text" id="mobile" name="SmsLoginModel[account]" class="text" value="" tabindex="1" placeholder="手机号码" autocomplete="off" />
                        </div>
                    ...
                    <div class="form-group form-group-spe form-group-phonecode">
                        <div class="form-control-box fl">
                            ...
                            <a id="btn_send_sms_code" href="javascript:void(0);" class="phonecode">获取验证码</a>
                        </div>
...
<script id="sms_client_rules" type="text/javascript">
    [{"id": "smsloginmodel-captcha", "name": "SmsLoginModel[captcha]", "attribute": "captcha", "rules": {"required":true,"messages":{"required":"请输入图片验证码"},"when":"function(){return $(\"#captcha_sms\").is(\":visible\") && $(\"#captcha_sms\").size() > 0;}"}},{"id": "smsloginmodel-captcha", "name": "SmsLoginModel[captcha]", "attribute": "captcha", "rules": {"captcha":{"hash":437,"hashKey":"niiCaptcha/site/captcha","caseSensitive":false},"messages":{"captcha":"验证码不正确。"},"when":"function(){return $(\"#captcha_sms\").is(\":visible\") && $(\"#captcha_sms\").size() > 0;}"}},{"id": "smsloginmodel-mobile", "name": "SmsLoginModel[mobile]", "attribute": "mobile", "rules": {"required":true,"messages":{"required":"请输入手机号码"}}},{"id": "smsloginmodel-smscaptcha", "name": "SmsLoginModel[smsCaptcha]", "attribute": "smsCaptcha", "rules": {"required":true,"messages":{"required":"请输入动态密码"}}},{"id": "smsloginmodel-smsaccount", "name": "SmsLoginModel[account]", "attribute": "smsAccount", "rules": {"required":true,"messages":{"required":"请输入一个有效的手机号码"}}},{"id": "smsloginmodel-mobile", "name": "SmsLoginModel[mobile]", "attribute": "mobile", "rules": {"match":{"pattern":/^(13[0-9]{1}[0-9]{8}|15[0-9]{1}[0-9]{8}|18[0-9]{1}[0-9]{8}|17[0-9]{1}[0-9]{8}|14[0-9]{1}[0-9]{8}|199[0-9]{8}|198[0-9]{8}|166[0-9]{8})$/,"not":false,"skipOnEmpty":1},"messages":{"match":"请输入一个有效的手机号码"}}},{"id": "smsloginmodel-rememberme", "name": "SmsLoginModel[rememberMe]", "attribute": "rememberMe", "rules": {"boolean":{"trueValue":"1","falseValue":"0"},"messages":{"boolean":"记住用户名密码必须要么为\"1\"，要么为\"0\"。"}}},]
</script>
...
// 移除错误样式
        ...
        $(container).find("#form1").submit(function() {
            // $.msg('123');return false;
            if(!validator1.form()){
                return false;
            }

            let account = $('input[name="SmsLoginModel[account]"]').val();
