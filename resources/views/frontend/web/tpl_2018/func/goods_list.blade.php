...
@section('content')
    ...
    <style type="text/css" media="all">
        *{box-sizing: border-box;line-height: 24px;}
        ...
        /**统一版式条件**/
        #content .content .headCon{background:{{$website['content']}};}
        #content .content .headCon2{border:1px solid #525252;}
        #content .content .headCon:first-child{border-top:1px solid {{$website['content']}};}
        #content .content .headCon .leftVal{font-size:15px;font-weight: 800;color:{{$website['fontcolor']}};text-align: left;width:10%;padding:7px 10px;border-bottom: 1px solid #fff;}
        #content .content .headCon .rightVal{padding:5px 10px;background:#ffffff;width: 90%;height:40px;overflow: hidden;position:relative;transition: all 0.3s ease;border-bottom: 1px solid #bebebe;}
        #content .content .headCon .rightVal .conItem{font-size:13px;width: 78px;display: inline-block;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;cursor:pointer;padding:5px 0;color:{{$website['fontcolor']}};}
        #content .content .headCon .conItem{cursor:pointer;font-size: 18px;color: {{$website['color_word']}};font-weight: 800;margin-right: 10px;}
        /**搜索条件**/
        .high_search{background:{{$website['content']}};}
        .high_search:first-child{border-top:1px solid {{$website['content']}};}
        .high_search .leftVal{font-size:15px;font-weight: 800;color:{{$website['fontcolor']}};text-align: left;width:15%;padding:7px 10px;/**border-bottom: 1px solid #fff;**/white-space:nowrap;}
        .high_search .rightVal{padding:5px 10px;background:#ffffff;width: 90%;height:40px;max-height:200px;overflow-y: auto;position:relative;transition: all 0.3s ease;border-bottom: 1px solid #bebebe;}
        ...
        .high_search .rightVal .loadmore_search2 .more_icon{width:7px;height:7px;border-top:1px solid {{$website['content']}};border-right:1px solid {{$website['content']}};transform: rotate(315deg);margin-left:5px;background:#ffffff;}
        ...
        .fieldsBox .fieldsContent .btn{border: 1px solid #1f5188;color:#1f5188;padding: 2px 10px;margin-left: 10px;font-size:15px;cursor:pointer;line-height:26px;}
        .fieldsBox .fieldsContent .btn:hover{background:#1f5188;color:#fff;}
        /**发货地区样式**/
        ...
        .fieldsBox .fieldsContent .areaBox2 .areaContent{position:absolute;top:30px;left:-1px;width:400px;height:fit-content;padding:10px;background:#fff;border: 1px solid #bebebe;box-shadow: 0px 0px 5px 1px #bebebe;z-index: 9;}
        ...
        .inputBox{padding: 5px 20px;background: {{$website['color']}};width: fit-content;margin: 0 auto;cursor: pointer;font-size: 15px;border: 1px solid {{$website['color_word']}};font-weight: 800;color:{{$website['color_word']}};}
        ...
        @media (max-width: 992px){
            body{min-width: 100%;}
            .detail_topimg, .non_topimg {margin-top: 110px;padding:0 !important;}
            .w1200{width: 100%;}
        ...
        <div class="w1200">
            <div class="content">
                <div class="disf headTxt" style="justify-content: space-between;padding: 10px 15px;box-sizing: border-box;">
                    ...
                    <div class="headTxt_rightTxt" style="color:#000;font-size: 15px;"><a href="" style="color:#000;">找不到想要的宝贝?尝试咨询<span class="headTxtAct">在线客服</span></a></div>
                </div>
                <div class="conditionDiv">
                    ...
                    <div class="selector_box" style="display: none;">
                        <div class="selector">
                            @if(!empty($condition['category']))
                                <div class="disf high_search">
                                     ...
                                     <div class="rightVal">
                                         @foreach($condition['category'] as $k2=>$v2)
                            ...
                            @if($hotsearchId==0)
                                @if(!empty($condition['options']))
                                    @foreach($condition['options'] as $k2=>$v2)
                                        <div class="disf high_search">
                                ...
                                @if(!empty($condition['brand']))
                                    <div class="disf high_search">
                                        ...
                                        <div class="rightVal">
                                            @foreach($condition['brand'] as $k2=>$v2)
                        ...
                        <!--已选-->
                        <div class="selected" style="display:@if(empty($g_condition))
                                none
                                @else
                                block
                                @endif;">
                    ...
                    <div class="fields_div" style="display: none;">
                        ...
                        @if(!empty($condition['column_content']))
                            @if(!empty($field_condition))
                                @foreach($condition['column_content'] as $k=>$v)
                                    @if($v['stype']==1)
                                        <!--价格幅度-->
                                        ...
                                        <?php $min = '-1';?>
                                        <?php $max = '-1';?>
                                        @foreach($field_condition as $k2=>$v2)
                                            @if($v2['id']==$v['id'])
                                                @if($min=='-1' && $max=='-1')
                                            ...
                                            <div class="fieldsContent price_box" style="display:none;">
                                                <div class="disf" style="justify-content: center;margin-top: 15px;">
                                                    <div class="name disf sortCon" onclick="sortCon(this,{{$v['id']}})">
                                                        {{$v['name']}}
                                                        <div class="sortDiv">
                                                            <div class="ascBox @if($sort==1)
                                                                    sortAct
@endif"></div>
                                                            <div class="descBox @if($sort==2)
                                                                    sortAct
@endif"></div>
                                                        </div>
                                                    </div>
                                                    <div class="operaBox disf">
{{--                                                        onclick="show_sureBtn(this)"--}}
                                    ...
                                    @elseif($v['stype']==3)
                                        ...
                                        <!--已选自定条件END-->
                                            ...
                                            <div class="fieldsContent" style="display:none;">
                                                <div class="disf">
                                                    <input type="checkbox" class="field_arr" id="checkbox{{$v['id']}}" data-id="{{$v['id']}}" value="{{$sel}}" onclick="checkbox_click(this)" @if($sel==1)
                                                    checked
                                                            @endif>
                                                    <div class="name">{{$v['name']}}</div>
                                                </div>
                                            ...
                                            <div class="fieldsContent" style="display:none;">
                                                <div class="disf areaBox" onclick="show_areaDetail(this)">
                                                    ...
                                                    <div class="areaContent" style="display:none;">
                                                        ...
                                                        @foreach($condition['province'] as $k2=>$v2)
                                                            <div class="areaDiv">
...
@endif"></div>
                                    ...
                                    <div class="operaBox disf">
                                        <select class="chosen-select currency" id="currency" onchange="sure_currency(this)">
                                            @foreach($currency as $k2=>$v2)
                                                <option value="{{$v2['id']}}" @if($currency_sel==$v2['id'])
                                                selected
                                                        @endif>{{$v2['name']}}：{{$v2['symbol']}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
    ...
    {{--                            <p class="noresult-item">2. 修改当前页您的搜索条件，重新搜索</p>--}}
                            </div>
                        @endif
                    </div>
                </div>
    ...
    <script>
                ...
                ,jump: function(obj, first){ // 分页跳转的回调
                    ...
                    if(!first){
                        ...
                        $.ajax({
                            url: "/goods_list",
                            method: 'post',
                            data: {'_token': "{{csrf_token()}}", 'pa': 1,'hotsearchId':"{{$hotsearchId}}",'cate_name':"{{$catename}}",'frame_id':"{{$id}}",'sort_info':"{{$sort_info}}",'g_condition':"{{$origin_condition}}",'field_condition':"{{$origin_field_condition}}",'page':obj.curr,'currency_sel':currency_sel},
                            dataType: 'JSON',
        ...
        function showCondition(typ,t){
            ...
            if(typ==1 || typ==2 || typ==3 || typ==5) {
                $.post('/getFrame',{'id':3,'type':99,'_token':'{{csrf_token()}}'},function(res) {
            ...
            //废弃
            if(typ==11 || typ==22 || typ==33){
                //按分类
                let html = '<div class="innerContent">';
                if(typ==1){
                    html += '<div class="levelItem levelActive" onclick="changeCondition(1,this)">按类别</div>';
                }else{
                    html += '<div class="levelItem" onclick="changeCondition(1,this)">按类别</div>';
                }
                if(typ==2) {
                    html += '<div class="levelItem levelActive" onclick="changeCondition(2,this)">按单价</div>';
                }else{
                    html += '<div class="levelItem" onclick="changeCondition(2,this)">按单价</div>';
                }
                if(typ==3) {
                    html += '<div class="levelItem levelActive" onclick="changeCondition(3,this)">按币种</div>';
                }else{
                    html += '<div class="levelItem" onclick="changeCondition(3,this)">按币种</div>';
                }
                ...
                $.post('/getFrame',{'id':9,'type':2,'_token':'{{csrf_token()}}'},function(res) {
                    //广告图
                    $('.windowBox .windowDiv .leftBox').find('.windowsAdv').attr('src','https://shop.gogo198.cn/'+res.adv['img']);
                    if(res.adv['link']!=''){
