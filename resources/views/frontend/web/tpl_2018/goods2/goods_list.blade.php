...
@section('content')
    ...
    <div class="w1210">
        ...
        @include('frontend.web.tpl_2018.goods2.partials.hot_sale_goods')
        ...
        <div class="content-wrap category-wrap clearfix">
            ...
            <div class="aside" >
                ...
                <div class="aside-inner">
                    ...
                    @include('frontend.web.tpl_2018.goods2.partials.new_goods')

                    <!--销量排行榜-->

                    @include('frontend.web.tpl_2018.goods2.partials.sale_rank_goods')
        ...
        <div class="browse-history">
            ...
            <div class="browse-history-con">
                <div class="browse-history-inner">
                    ...
                    <!--浏览历史-->
                    @include('frontend.web.tpl_2018.goods2.partials.history_goods')
