        ...
        <div class="layui-card-body" style="padding: 10px;">
            <form class="layui-form" action="" lay-filter="component-form-group">
                            ...
                            <div class="info_div">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="name" id="name" lay-verify="required" placeholder="群组名称" autocomplete="off" class="layui-input" value="{{$data['name']}}" @if( $method==3)
                                        disabled style="background:#aaaaaa;"
                                   @endif>
                                    </div>
                                </div>
                                <div class="layui-form-item">
                        ...
                        <div class="layui-colla-content">
                            <div class="info_div">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <select name="group_id" id="group_id" lay-verify="required" lay-search @if($id>0)
                                            disabled  style="background:#aaaaaa;"
                                        @endif>
                                            <option value="">请选择</option>
                                            @foreach($group as $k=>$vo)
                                            <option value="{{$vo['id']}}" @if($data['group_id']==$vo['id'])
                                                selected
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" placeholder="用顿号“、”分割邮箱号码" name="cc_member2" class="layui-input" autocomplete="off" value="{{$data['cc_member2']}}" @if($id>0)
                                        disabled  style="background:#aaaaaa;"
                                       @endif>
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <select name="pass_method" lay-filter="method">
                                            <option value="1" @if($data['pass_method']==1)
                                                selected
                                            @endif>一致决议=100%</option>
                                            <option value="2" @if($data['pass_method']==2)
                                                selected
                                            @endif>多数决议≥60%</option>
                                            <option value="3" @if($data['pass_method']==3)
                                                selected
                                            @endif>半数决议≥50%</option>
                                            <option value="4" @if($data['pass_method']==4)
                                                selected
                                            @endif>少数决议<50%</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="layui-colla-item">
                        ...
                        <div class="layui-colla-content">
                            <div class="layui-collapse" lay-accordion="" style="margin:10px 0 30px 0;">
                                ...
                                <div class="layui-colla-item">
                                    <h2 class="layui-colla-title"><div class="disf" style="justify-content: space-between;"><div class="sel_box" style="width: 44%;"><span class="sel">{{$vo['name']}}</span></div><div>@if($key>1)
                                                    <div class="layui-btn layui-btn-danger member_btn" onclick="del_option(this)">-</div>
                                    @endif
                                        <div class="layui-btn layui-btn-parimary member_btn" onclick="add_option(this)">+</div></div></div></h2>
                        ...
                        <div class="layui-colla-content">
                            <div class="info_div">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" class="layui-input" name="starttime" id="starttime" value="{{$data['starttime']}}" placeholder="开始时间" lay-verify="required" @if($id>0)
                                            disabled  style="background:#aaaaaa;"
                                        @endif>
                                    </div>
                                </div>
                ...
                <div class="layui-form-item" style="margin-top:10px;text-align: center;">
                    <button class="layui-btn" lay-submit="" lay-filter="component-form-demo1">@if($id>0)
                            立即保存
                        @else
                            立即发起
                        @endif</button>
...
<script>
    ...
    function del_option(t){
        ...
        var c = layer.confirm('确认要删除该选项吗？',{
            ...
            layer.close(c);
            @if($id>0)
            $.post('/member/del_options',{'topics_id':"{{$id}}",'name':$(t).parents(":eq(1)").find(".sel_box").find('.sel').text()},function(res){
                layer.msg(res.msg, {time: 2000}, function () {
                    if (res.code == 0) {
