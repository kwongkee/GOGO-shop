...
<script>
    layui.config({
        ...
        table.render({
            elem: '#mainTable'
            ,url: "/member/topics_manage&pa2={{$pa}}&group_id={{$group_id}}"
            ,cellMinWidth: 200
            ,cols: [[
                ...
                ,{width:90, align:'center', fixed: 'right', title: '操作', templet: function(d){
                        return [
                            '<a onclick="openWindow2('+ "'["+d.name+"]'" +',' + "'/member/topics_manage2&id="+ d.id +"'" + ');" class="layui-btn layui-btn-xs layui-btn-normal">管理决策</a>',
