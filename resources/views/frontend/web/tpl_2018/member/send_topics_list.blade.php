...
<style type="text/css">
    ...
    .layui-colla-title2 .num{width:20%;text-align: center;margin-right: 3%;border-right: 1px solid {{$website['color_word']}};}
                ...
                <div class="layui-collapse" lay-accordion="now" style="margin:10px 0 30px 0;">
                    ...
                    <div class="layui-colla-item">
                        <h2 class="layui-colla-title2 disf">
                            ...
                            <div class="arrow_div r_blue" onclick="change_colla(this)">
                                <div class="@if($key==1)
                                        arrow2
                                    @else
                                        arrow
    ...
    function edit_topics(is_ending,name,already_resolution,id){
        ...
        if(already_resolution==0){
            ...
            var index = layer.open({
                type: 2,
                title: name,
                content: '/member/save_topics&id='+id+'&method=3',
                area:['100%','100%']
            });
        }
            ...
            var index = layer.open({
                type: 2,
                title: name,
                content: '/member/save_topics&id='+id+'&method=4',
                area:['100%','100%']
            });
        }
    }
