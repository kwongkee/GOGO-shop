...
<div class="header login-header w990">
    <div class="logo-info">
        <a href="https://{{ env('FRONTEND_DOMAIN') }}/" class="logo">
    ...
    <div class="logo-right">
        <ul class="logo-right-menu">
            <li ><a class="seller" href="https://{{ env('SELLER_DOMAIN') }}/index.html" target="_blank"><i></i>商家管理中心</a></li>
            <li class="current"><a class="store" href="https://{{ env('STORE_DOMAIN') }}/index.html" target="_blank"><i></i>网点管理中心</a></li>
        </ul>
    </div>
</div>
                    ...
                    <div class="login-mobile hide">
                        <div class="default-state">
                            ...
                            <div class="login-links">
                                ...
                                <a href="https://{{ env('FRONTEND_DOMAIN') }}/register.html" class="register" target="_blank">免费注册</a>
                            </div>
                        </div>
                    </div>
                    <!-- 扫码登录 end -->
